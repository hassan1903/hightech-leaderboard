...
*/
            ...
            if (!errors.b.b) {
              ...
              var introduction =
                ...
                (" failed in the following " +
                  ($elm$core$String$fromInt($elm$core$List$length(errors)) + " ways:"))
              return A2(
  ...
  var $elm$core$Array$treeFromBuilder = F2(function (nodeList, nodeListSize) {
    treeFromBuilder: while (true) {
      ...
      if (newNodeSize === 1) {
        return A2($elm$core$Elm$JsArray$initializeFromList, $elm$core$Array$branchFactor, nodeList)
          .a
      } else {
  ...
  var $author$project$Main$LeaderboardDataResponse = function (a) {
    return { $: "LeaderboardDataResponse", a: a }
  }
  var $elm$core$Basics$composeR = F3(function (f, g, x) {
    return g(f(x))
  })
  var $author$project$Main$HttpPlayerData = F4(function (
    playerId,
    hasBeenForgotten,
    playerInvocations,
    playerProgress
    ...
    return {
      hasBeenForgotten: hasBeenForgotten,
      playerId: playerId,
      playerInvocations: playerInvocations,
      playerProgress: playerProgress
    }
  })
  var $elm$json$Json$Decode$bool = _Json_decodeBool
  var $author$project$Main$PlayerInvocations = F2(function (http, gRPC) {
    return { gRPC: gRPC, http: http }
  })
  ...
  var $NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required = F3(function (
    key,
    valDecoder,
    decoder
  ) {
  ...
  var $author$project$Main$decodePlayerInvocations = A3(
    ...
    A3(
      ...
      "invocationsViaHTTP",
      $elm$json$Json$Decode$int,
      $elm$json$Json$Decode$succeed($author$project$Main$PlayerInvocations)
    )
  )
  var $author$project$Main$SignalRPlayerData = F8(function (
    playerId,
    name,
    eEgg,
    score,
    ...
    return {
      ...
      eEgg: eEgg,
      mazePlayInfos: mazePlayInfos,
      name: name,
      playerId: playerId,
      score: score,
      scoreInBag: scoreInBag,
      scoreInHand: scoreInHand
    }
  })
  var $author$project$Main$SignalRMazePlayInfo = F4(function (
    hasBeenPlayed,
    name,
    obtainedReward,
    potentialReward
  ...
  var $author$project$Main$decodeMazePlayInfo = A3(
    $NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
    "potentialReward",
    $elm$json$Json$Decode$int,
    A3(
      ...
      A3(
        ...
        A3(
          ...
          $elm$json$Json$Decode$succeed($author$project$Main$SignalRMazePlayInfo)
        )
      )
    )
  )
  var $elm$json$Json$Decode$list = _Json_decodeList
  var $author$project$Main$decodePlayerProgress = A3(
    $NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
    "mazePlayInfos",
    $elm$json$Json$Decode$list($author$project$Main$decodeMazePlayInfo),
    A3(
      $NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
      "currentMaze",
      $elm$json$Json$Decode$string,
            ...
            A3(
              ...
              A3(
                ...
                A3(
                  ...
                  "playerId",
                  $elm$json$Json$Decode$string,
                  $elm$json$Json$Decode$succeed($author$project$Main$SignalRPlayerData)
                )
              )
            )
          )
  ...
  var $NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optionalDecoder = F3(function (
    pathDecoder,
    valDecoder,
    fallback
  ) {
  ...
  var $NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional = F4(function (
    key,
    valDecoder,
    fallback,
    decoder
  ...
  var $author$project$Main$decodeHttpPlayerData = A4(
    $NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
    "playerProgress",
    A2($elm$json$Json$Decode$map, $elm$core$Maybe$Just, $author$project$Main$decodePlayerProgress),
    $elm$core$Maybe$Nothing,
    A3(
      $NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
      "invocations",
      $author$project$Main$decodePlayerInvocations,
      A3(
        $NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
        "hasBeenForgotten",
        $elm$json$Json$Decode$bool,
        A3(
          ...
          "playerId",
          $elm$json$Json$Decode$string,
          $elm$json$Json$Decode$succeed($author$project$Main$HttpPlayerData)
        )
      )
    )
  )
  var $author$project$Main$decodeLeaderboardAllData = $elm$json$Json$Decode$list(
    $author$project$Main$decodeHttpPlayerData
  )
        ...
        if (cmd.$ === "Cancel") {
          ...
          return A2(
            ...
            $elm$core$Process$spawn(
              A3(_Http_toTask, router, $elm$core$Platform$sendToApp(router), req)
            )
          )
        }
      }
  ...
  var $elm$http$Http$maybeSend = F4(function (router, desiredTracker, progress, _v0) {
    ...
    return _Utils_eq(desiredTracker, actualTracker)
      ? $elm$core$Maybe$Just(A2($elm$core$Platform$sendToApp, router, toMsg(progress)))
      : $elm$core$Maybe$Nothing
  })
  ...
  var $author$project$Main$getLeaderboardAllData = $elm$http$Http$get({
    expect: A2(
      $elm$http$Http$expectJson,
      A2(
        $elm$core$Basics$composeR,
        $krisajenkins$remotedata$RemoteData$fromResult,
        $author$project$Main$LeaderboardDataResponse
      ),
      $author$project$Main$decodeLeaderboardAllData
    ),
    url: "api/leaderboard/allData"
  })
  var $author$project$Main$init = function (_v0) {
    return _Utils_Tuple2(
      { isSignalRConnected: false, players: $elm$core$Dict$empty },
      $author$project$Main$getLeaderboardAllData
    )
  }
  var $author$project$Main$OnPlayerForgotten = function (a) {
    return { $: "OnPlayerForgotten", a: a }
  }
  var $author$project$Main$OnPlayerInvocations = function (a) {
    return { $: "OnPlayerInvocations", a: a }
  }
  var $author$project$Main$OnPlayerUpdated = function (a) {
    return { $: "OnPlayerUpdated", a: a }
  }
  var $author$project$Main$OnSignalRConnectionChanged = function (a) {
    return { $: "OnSignalRConnectionChanged", a: a }
  }
  var $elm$core$Platform$Sub$batch = _Platform_batch
  var $author$project$Main$onSignalRConnection = _Platform_incomingPort(
    "onSignalRConnection",
    $elm$json$Json$Decode$bool
  )
  var $author$project$Main$playerForgotten = _Platform_incomingPort(
    "playerForgotten",
    $elm$json$Json$Decode$string
  )
  var $elm$json$Json$Decode$index = _Json_decodeIndex
  var $author$project$Main$playerInvocations = _Platform_incomingPort(
    "playerInvocations",
    A2(
            ...
            A2(
              ...
              function (http) {
                return A2(
                  $elm$json$Json$Decode$andThen,
                  function (gRPC) {
                    return $elm$json$Json$Decode$succeed({ gRPC: gRPC, http: http })
                  },
                  A2($elm$json$Json$Decode$field, "gRPC", $elm$json$Json$Decode$int)
                )
              },
              A2($elm$json$Json$Decode$field, "http", $elm$json$Json$Decode$int)
            )
          )
        )
      },
  ...
  var $author$project$Main$playerUpdated = _Platform_incomingPort(
    "playerUpdated",
    A2(
      $elm$json$Json$Decode$andThen,
      function (scoreInHand) {
        return A2(
          $elm$json$Json$Decode$andThen,
          function (scoreInBag) {
            return A2(
                        ...
                        return A2(
                          ...
                          function (mazePlayInfos) {
                            return A2(
                              ...
                              A2($elm$json$Json$Decode$field, "eEgg", $elm$json$Json$Decode$bool)
                            )
                          },
                          A2(
                            $elm$json$Json$Decode$field,
                            ...
                            $elm$json$Json$Decode$list(
                              A2(
                                $elm$json$Json$Decode$andThen,
                                function (potentialReward) {
                                  return A2(
                                    $elm$json$Json$Decode$andThen,
                                    function (obtainedReward) {
                                      return A2(
                                        $elm$json$Json$Decode$andThen,
                                        function (name) {
                                          return A2(
          ...
          A2($elm$json$Json$Decode$field, "scoreInBag", $elm$json$Json$Decode$int)
        )
      },
      A2($elm$json$Json$Decode$field, "scoreInHand", $elm$json$Json$Decode$int)
    )
  )
  var $author$project$Main$subscriptions = function (model) {
    return $elm$core$Platform$Sub$batch(
      _List_fromArray([
        $author$project$Main$playerInvocations($author$project$Main$OnPlayerInvocations),
        $author$project$Main$playerUpdated($author$project$Main$OnPlayerUpdated),
        $author$project$Main$playerForgotten($author$project$Main$OnPlayerForgotten),
        $author$project$Main$onSignalRConnection($author$project$Main$OnSignalRConnectionChanged)
      ])
    )
  }
  var $author$project$Main$RefreshLeaderboardData = { $: "RefreshLeaderboardData" }
  var $andrewMacmurray$elm_delay$Delay$Second = { $: "Second" }
  var $andrewMacmurray$elm_delay$Delay$Duration = F2(function (a, b) {
  ...
  var $andrewMacmurray$elm_delay$Delay$after_ = F2(function (time, msg) {
    return A2($elm$core$Task$perform, $elm$core$Basics$always(msg), $elm$core$Process$sleep(time))
  })
    ...
    switch (u.$) {
      ...
      case "Minute":
        return $andrewMacmurray$elm_delay$Delay$toMillis(
          A2(
            $andrewMacmurray$elm_delay$Delay$Duration,
            60 * t,
      ...
      default:
        return $andrewMacmurray$elm_delay$Delay$toMillis(
          A2(
            $andrewMacmurray$elm_delay$Delay$Duration,
            60 * t,
            $andrewMacmurray$elm_delay$Delay$Minute
          )
        )
    }
  }
  var $andrewMacmurray$elm_delay$Delay$after = F3(function (time, unit, msg) {
    return A2(
  ...
  var $author$project$Main$ghostPlayer = F2(function (playerId, invocations) {
    return {
      hasFoundEasterEgg: $elm$core$Maybe$Nothing,
      invocations: invocations,
      mazeResults: $elm$core$Dict$empty,
      name: "👻",
      playerId: playerId,
      score: 0,
      scoreInBag: 0,
  ...
  var $author$project$Main$initInvocations = { gRPC: 0, http: 0 }
  var $author$project$Main$forgetPlayer = F2(function (playerId, model) {
    var updatePlayer = function (maybePlayer) {
      if (maybePlayer.$ === "Just") {
        var p = maybePlayer.a
        return $elm$core$Maybe$Just(A2($author$project$Main$ghostPlayer, playerId, p.invocations))
      } else {
        return $elm$core$Maybe$Just(
          A2($author$project$Main$ghostPlayer, playerId, $author$project$Main$initInvocations)
        )
      }
    }
    var updatedPlayers = A3($elm$core$Dict$update, playerId, updatePlayer, model.players)
    return _Utils_update(model, { players: updatedPlayers })
  })
  var $elm$core$Platform$Cmd$batch = _Platform_batch
  var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil)
  var $author$project$Main$Imperfect = function (a) {
    return { $: "Imperfect", a: a }
  }
  var $author$project$Main$InProgress = function (a) {
    return { $: "InProgress", a: a }
  }
  var $author$project$Main$NotPlayed = { $: "NotPlayed" }
  var $author$project$Main$Perfect = { $: "Perfect" }
  var $author$project$Main$Played = function (a) {
    return { $: "Played", a: a }
  }
  ...
  var $author$project$Main$activePlayer = F2(function (playerData, invocations) {
    var toMazeResult = function (signalRMazePlayInfo) {
      var progress =
        ((playerData.scoreInHand + playerData.scoreInBag) / signalRMazePlayInfo.potentialReward) *
        100
      var mazeStatus = _Utils_eq(playerData.currentMaze, signalRMazePlayInfo.name)
        ? $author$project$Main$InProgress($elm$core$Basics$round(progress))
        : signalRMazePlayInfo.hasBeenPlayed
        ? _Utils_eq(signalRMazePlayInfo.potentialReward, signalRMazePlayInfo.obtainedReward)
          ? $author$project$Main$Played($author$project$Main$Perfect)
          : $author$project$Main$Played(
              $author$project$Main$Imperfect(
                $elm$core$Basics$round(
                  (signalRMazePlayInfo.obtainedReward / signalRMazePlayInfo.potentialReward) * 100
                )
              )
            )
        : $author$project$Main$NotPlayed
      return _Utils_Tuple2(signalRMazePlayInfo.name, mazeStatus)
    }
    return {
      hasFoundEasterEgg: $elm$core$Maybe$Just(playerData.eEgg),
      invocations: invocations,
      mazeResults: $elm$core$Dict$fromList(
        A2($elm$core$List$map, toMazeResult, playerData.mazePlayInfos)
      ),
      name: playerData.name,
      playerId: playerData.playerId,
      score: playerData.score,
      scoreInBag: playerData.scoreInBag,
      scoreInHand: playerData.scoreInHand
    }
  })
  var $author$project$Main$fromHttpLeaderboardData = function (fullLeaderboardData) {
    var toPlayer = function (h) {
      var _v0 = h.playerProgress
      if (_v0.$ === "Just") {
        var playerData = _v0.a
        return A2($author$project$Main$activePlayer, playerData, h.playerInvocations)
      } else {
        return A2($author$project$Main$ghostPlayer, h.playerId, h.playerInvocations)
      }
    }
    return $elm$core$Dict$fromList(
      A2(
        $elm$core$List$map,
        function (i) {
          return _Utils_Tuple2(i.playerId, toPlayer(i))
        },
        fullLeaderboardData
      )
    )
  }
  var $author$project$Main$setPlayerDataFromHttpResponse = F2(function (response, model) {
    if (response.$ === "Success") {
      var leaderboardData = response.a
      return _Utils_update(model, {
        players: $author$project$Main$fromHttpLeaderboardData(leaderboardData)
      })
    } else {
      return model
    }
  })
  var $author$project$Main$setPlayerInvocations = F3(function (playerId, invocations, model) {
    var updatePlayer = function (maybePlayer) {
      if (maybePlayer.$ === "Just") {
        var p = maybePlayer.a
        return $elm$core$Maybe$Just(_Utils_update(p, { invocations: invocations }))
      } else {
        return $elm$core$Maybe$Just(A2($author$project$Main$ghostPlayer, playerId, invocations))
      }
    }
    var updatedPlayers = A3($elm$core$Dict$update, playerId, updatePlayer, model.players)
    return _Utils_update(model, { players: updatedPlayers })
  })
  var $author$project$Main$updatePlayerData = F2(function (newPlayerData, model) {
    var player = function (invocations) {
      return $elm$core$Maybe$Just(A2($author$project$Main$activePlayer, newPlayerData, invocations))
    }
    var updatePlayer = function (maybePlayer) {
      if (maybePlayer.$ === "Just") {
        var p = maybePlayer.a
        return player(p.invocations)
      } else {
        return player($author$project$Main$initInvocations)
      }
    }
  ...
  var $author$project$Main$update = F2(function (msg, model) {
    switch (msg.$) {
      case "OnPlayerInvocations":
        var _v1 = msg.a
        var playerId = _v1.a
        var invocations = _v1.b
        return _Utils_Tuple2(
          A3($author$project$Main$setPlayerInvocations, playerId, invocations, model),
          $elm$core$Platform$Cmd$none
        )
      case "OnPlayerUpdated":
        var newPlayerData = msg.a
        return _Utils_Tuple2(
          A2($author$project$Main$updatePlayerData, newPlayerData, model),
          $elm$core$Platform$Cmd$none
        )
      case "OnPlayerForgotten":
        var playerId = msg.a
        return _Utils_Tuple2(
          A2($author$project$Main$forgetPlayer, playerId, model),
          $elm$core$Platform$Cmd$none
        )
      case "OnSignalRConnectionChanged":
        var newSignalRStatus = msg.a
        return _Utils_Tuple2(
          _Utils_update(model, { isSignalRConnected: newSignalRStatus }),
          $elm$core$Platform$Cmd$none
        )
      case "RefreshLeaderboardData":
        return _Utils_Tuple2(model, $author$project$Main$getLeaderboardAllData)
      default:
        var response = msg.a
        return _Utils_Tuple2(
          A2($author$project$Main$setPlayerDataFromHttpResponse, response, model),
          A3(
            $andrewMacmurray$elm_delay$Delay$after,
            1,
            $andrewMacmurray$elm_delay$Delay$Second,
            $author$project$Main$RefreshLeaderboardData
          )
        )
    }
  })
  ...
  var $mdgriffith$style_elements$Style$Internal$Model$FlexLayout = F2(function (a, b) {
  ...
  var $mdgriffith$style_elements$Element$column = F3(function (style, attrs, children) {
  ...
  var $mdgriffith$style_elements$Element$row = F3(function (style, attrs, children) {
    return $mdgriffith$style_elements$Element$Internal$Model$Layout({
      absolutelyPositioned: $elm$core$Maybe$Nothing,
      attrs: attrs,
      children: $mdgriffith$style_elements$Element$Internal$Model$Normal(children),
  ...
  var $mdgriffith$style_elements$Element$Internal$Model$Spacing = F2(function (a, b) {
  ...
  var $mdgriffith$style_elements$Element$Internal$Model$Text = F2(function (a, b) {
    return { $: "Text", a: a, b: b }
  })
  var $mdgriffith$style_elements$Element$text =
    $mdgriffith$style_elements$Element$Internal$Model$Text({
      decoration: $mdgriffith$style_elements$Element$Internal$Model$NoDecoration,
      inline: false
    })
  var $author$project$Main$mazeLegend = function (_v0) {
    var index = _v0.a
    var mazeName = _v0.b
    return A3(
      $mdgriffith$style_elements$Element$row,
      $author$project$Main$NoStyle,
      _List_fromArray([$mdgriffith$style_elements$Element$Attributes$spacing(5)]),
      _List_fromArray([
        $mdgriffith$style_elements$Element$text($elm$core$String$fromInt(index)),
        $mdgriffith$style_elements$Element$text(mazeName)
      ])
    )
  }
  var $mdgriffith$style_elements$Element$Internal$Model$Padding = F4(function (a, b, c, d) {
  ...
  var $mdgriffith$style_elements$Element$wrappedRow = F3(function (style, attrs, children) {
    return $mdgriffith$style_elements$Element$Internal$Model$Layout({
      absolutelyPositioned: $elm$core$Maybe$Nothing,
      attrs: attrs,
      children: $mdgriffith$style_elements$Element$Internal$Model$Normal(children),
      layout: A2(
        $mdgriffith$style_elements$Style$Internal$Model$FlexLayout,
        $mdgriffith$style_elements$Style$Internal$Model$GoRight,
        _List_fromArray([$mdgriffith$style_elements$Style$Internal$Model$Wrap(true)])
      ),
      node: "div",
      style: $elm$core$Maybe$Just(style)
    })
  })
  var $author$project$Main$mazeLegendRow = function (model) {
    var incrementIndex = F2(function (index, data) {
      return _Utils_Tuple2(index + 1, data)
    })
    var mazeNames = (function () {
      var _v0 = $elm$core$Dict$toList(model.players)
      if (_v0.b) {
        var _v1 = _v0.a
        var playerData = _v1.b
        return A2(
          $elm$core$List$indexedMap,
          incrementIndex,
          $elm$core$Dict$keys(playerData.mazeResults)
        )
      } else {
        return _List_Nil
      }
    ...
    return A3(
      ...
      _List_fromArray([
        ...
        $mdgriffith$style_elements$Element$Attributes$padding(20)
      ]),
      A2($elm$core$List$map, $author$project$Main$mazeLegend, mazeNames)
    )
  }
  var $author$project$Main$PlayerIdText = { $: "PlayerIdText" }
  var $author$project$Main$RowStyle = function (a) {
    return { $: "RowStyle", a: a }
  }
  var $mdgriffith$style_elements$Element$Internal$Model$Element = function (a) {
    return { $: "Element", a: a }
  }
  var $mdgriffith$style_elements$Element$el = F3(function (style, attrs, child) {
  ...
  var $mdgriffith$style_elements$Element$empty =
    $mdgriffith$style_elements$Element$Internal$Model$Empty
  var $author$project$Main$MazeBackground = { $: "MazeBackground" }
  ...
  var $mdgriffith$style_elements$Element$Attributes$alignBottom =
    $mdgriffith$style_elements$Element$Internal$Model$VAlign(
      $mdgriffith$style_elements$Element$Internal$Model$Bottom
    )
  var $mdgriffith$style_elements$Element$Internal$Model$Height = function (a) {
    return { $: "Height", a: a }
  }
  var $mdgriffith$style_elements$Element$Attributes$height =
    $mdgriffith$style_elements$Element$Internal$Model$Height
  var $mdgriffith$style_elements$Style$Internal$Model$Px = function (a) {
    return { $: "Px", a: a }
  }
  var $mdgriffith$style_elements$Element$Attributes$px =
    $mdgriffith$style_elements$Style$Internal$Model$Px
  var $author$project$Main$mazeStatusCellHeight =
    $mdgriffith$style_elements$Element$Attributes$px(40)
  var $author$project$Main$mazeStatusCellWidth =
    $mdgriffith$style_elements$Element$Attributes$px(20)
  var $author$project$Main$MazeInProgress = { $: "MazeInProgress" }
  var $author$project$Main$MazePlayedImperfect = { $: "MazePlayedImperfect" }
  var $author$project$Main$MazePlayedPerfect = { $: "MazePlayedPerfect" }
  var $mdgriffith$style_elements$Style$Internal$Model$Percent = function (a) {
    return { $: "Percent", a: a }
  }
  var $mdgriffith$style_elements$Element$Attributes$percent =
    $mdgriffith$style_elements$Style$Internal$Model$Percent
  var $mdgriffith$style_elements$Element$Internal$Model$Width = function (a) {
    return { $: "Width", a: a }
  }
  var $mdgriffith$style_elements$Element$Attributes$width =
    $mdgriffith$style_elements$Element$Internal$Model$Width
  var $author$project$Main$renderMazeStatus = function (status) {
    switch (status.$) {
      case "NotPlayed":
      ...
      case "InProgress":
        ...
        return A3(
          ...
          $author$project$Main$MazeInProgress,
          _List_fromArray([
            $mdgriffith$style_elements$Element$Attributes$height(
              $mdgriffith$style_elements$Element$Attributes$percent(score)
            ),
      ...
      default:
        if (status.a.$ === "Perfect") {
          ...
          return A3(
            $mdgriffith$style_elements$Element$el,
            $author$project$Main$MazePlayedPerfect,
            _List_fromArray([
              $mdgriffith$style_elements$Element$Attributes$height(
                $mdgriffith$style_elements$Element$Attributes$percent(100)
              ),
          ...
          var score = status.a.a
          return A3(
            $mdgriffith$style_elements$Element$el,
            $author$project$Main$MazePlayedImperfect,
            _List_fromArray([
              $mdgriffith$style_elements$Element$Attributes$height(
                $mdgriffith$style_elements$Element$Attributes$percent(score)
              ),
  ...
  var $author$project$Main$mazeStatusView = function (status) {
    return A3(
      $mdgriffith$style_elements$Element$column,
      $author$project$Main$MazeBackground,
      _List_fromArray([
        $mdgriffith$style_elements$Element$Attributes$width(
          $author$project$Main$mazeStatusCellWidth
        ),
        $mdgriffith$style_elements$Element$Attributes$height(
          $author$project$Main$mazeStatusCellHeight
        ),
        $mdgriffith$style_elements$Element$Attributes$alignBottom
      ]),
      _List_fromArray([$author$project$Main$renderMazeStatus(status)])
    )
  }
  var $author$project$Main$InvocationsText = { $: "InvocationsText" }
  ...
  var $mdgriffith$style_elements$Element$Attributes$alignRight =
    $mdgriffith$style_elements$Element$Internal$Model$HAlign(
      $mdgriffith$style_elements$Element$Internal$Model$Right
    )
  var $mdgriffith$style_elements$Element$Internal$Model$VerticalCenter = { $: "VerticalCenter" }
  var $mdgriffith$style_elements$Element$Attributes$verticalCenter =
    $mdgriffith$style_elements$Element$Internal$Model$VAlign(
      $mdgriffith$style_elements$Element$Internal$Model$VerticalCenter
    )
  var $author$project$Main$playerInvocationsView = function (invocations) {
    return A3(
      $mdgriffith$style_elements$Element$column,
      $author$project$Main$InvocationsText,
      _List_fromArray([
        $mdgriffith$style_elements$Element$Attributes$width(
          $mdgriffith$style_elements$Element$Attributes$percent(10)
        ),
      ...
      _List_fromArray([
        $mdgriffith$style_elements$Element$text(
          "HTTP: " + $elm$core$String$fromInt(invocations.http)
        ),
        $mdgriffith$style_elements$Element$text(
          "gRPC: " + $elm$core$String$fromInt(invocations.gRPC)
        )
      ])
    )
  }
  var $author$project$Main$scoreInHandAndBag = function (playerData) {
    return A3(
      $mdgriffith$style_elements$Element$column,
      $author$project$Main$NoStyle,
      _List_fromArray([
      ...
      _List_fromArray([
        $mdgriffith$style_elements$Element$text(
          "🖐 " + $elm$core$String$fromInt(playerData.scoreInHand)
        ),
        $mdgriffith$style_elements$Element$text(
          "🎒 " + $elm$core$String$fromInt(playerData.scoreInBag)
        )
      ])
    )
  }
  var $author$project$Main$toOrdinal = function (position) {
    var rem100 = position % 100
    var rem10 = position % 10
    var suffix = (function () {
      var _v0 = _Utils_Tuple2(rem100, rem10)
      switch (_v0.a) {
        case 11:
          return "th"
        case 12:
    ...
    return _Utils_ap($elm$core$String$fromInt(position), suffix)
  }
  var $author$project$Main$Even = { $: "Even" }
  var $author$project$Main$Odd = { $: "Odd" }
  var $author$project$Main$toStyle = function (position) {
    return !(position % 2) ? $author$project$Main$Even : $author$project$Main$Odd
  }
  ...
  var $author$project$Main$playerRow = F2(function (position, playerData) {
    var newPosition = position + 1
    var easterEgg = (function () {
      var _v0 = playerData.hasFoundEasterEgg
      if (_v0.$ === "Just") {
        if (_v0.a) {
          return $mdgriffith$style_elements$Element$text(" 🐣")
        } else {
          return $mdgriffith$style_elements$Element$text(" \uD83E\uDD5A")
        }
      } else {
    ...
    return A3(
      $mdgriffith$style_elements$Element$row,
      $author$project$Main$RowStyle($author$project$Main$toStyle(position)),
      _List_fromArray([
      ...
      _List_fromArray([
        A3(
          ...
          _List_fromArray([
            $mdgriffith$style_elements$Element$Attributes$width(
              $mdgriffith$style_elements$Element$Attributes$percent(5)
            )
          ]),
          $mdgriffith$style_elements$Element$text($author$project$Main$toOrdinal(newPosition))
        ),
        A3(
          $mdgriffith$style_elements$Element$el,
          $author$project$Main$PlayerIdText,
          _List_fromArray([
            $mdgriffith$style_elements$Element$Attributes$width(
              $mdgriffith$style_elements$Element$Attributes$percent(5)
            )
          ]),
          $mdgriffith$style_elements$Element$text(playerData.playerId)
        ),
        A3(
          $mdgriffith$style_elements$Element$row,
          $author$project$Main$NoStyle,
          _List_fromArray([
            $mdgriffith$style_elements$Element$Attributes$width(
              $mdgriffith$style_elements$Element$Attributes$percent(15)
            )
          ]),
          _List_fromArray([$mdgriffith$style_elements$Element$text(playerData.name), easterEgg])
        ),
        A3(
          $mdgriffith$style_elements$Element$el,
          $author$project$Main$NoStyle,
          ...
          $mdgriffith$style_elements$Element$text(
            "💰 " + $elm$core$String$fromInt(playerData.score)
          )
        ),
        $author$project$Main$scoreInHandAndBag(playerData),
        A3(
          $mdgriffith$style_elements$Element$row,
          $author$project$Main$NoStyle,
          _List_fromArray([$mdgriffith$style_elements$Element$Attributes$spacing(10)]),
          A2(
            $elm$core$List$map,
            $author$project$Main$mazeStatusView,
            $elm$core$Dict$values(playerData.mazeResults)
          )
        ),
        $author$project$Main$playerInvocationsView(playerData.invocations)
      ])
    )
  })
  var $author$project$Main$MazeName = { $: "MazeName" }
  var $author$project$Main$mazeNameCell = function (mazeName) {
    return A3(
      $mdgriffith$style_elements$Element$el,
      $author$project$Main$MazeName,
      _List_fromArray([
        $mdgriffith$style_elements$Element$Attributes$width(
          $author$project$Main$mazeStatusCellWidth
        )
      ]),
      $mdgriffith$style_elements$Element$text($elm$core$String$fromInt(mazeName))
    )
  }
  var $author$project$Main$playersHeaderRow = function (model) {
    var mazeNames = (function () {
      var _v0 = $elm$core$Dict$toList(model.players)
      if (_v0.b) {
        var _v1 = _v0.a
        var playerData = _v1.b
        return $elm$core$Dict$keys(playerData.mazeResults)
      } else {
        return _List_Nil
      }
    })()
    return A3(
      ...
      _List_fromArray([
        ...
        A3(
          ...
          A2(
            $elm$core$List$map,
            $author$project$Main$mazeNameCell,
            A2($elm$core$List$range, 1, $elm$core$List$length(mazeNames))
          )
        )
      ])
    )
  }
  var $author$project$Main$sortByScoreAndInvocations = F2(function (p1, p2) {
    var invocations = function (a) {
      return a.invocations.http + a.invocations.gRPC
    }
    var compareByScore = A2($elm$core$Basics$compare, p1.score, p2.score)
    var compareByInvocations = A2($elm$core$Basics$compare, invocations(p1), invocations(p2))
    var _v0 = _Utils_Tuple2(compareByScore, compareByInvocations)
    _v0$2: while (true) {
      if (_v0.a.$ === "EQ") {
        switch (_v0.b.$) {
          case "LT":
  ...
  var $author$project$Main$body = function (model) {
    return A3(
      ...
      A2(
        $elm$core$List$cons,
        $author$project$Main$playersHeaderRow(model),
        _Utils_ap(
          A2(
            $elm$core$List$indexedMap,
            $author$project$Main$playerRow,
            $elm$core$List$reverse(
              A2(
                $elm$core$List$sortWith,
                $author$project$Main$sortByScoreAndInvocations,
                $elm$core$Dict$values(model.players)
              )
            )
          ),
          _List_fromArray([$author$project$Main$mazeLegendRow(model)])
        )
      )
    )
  }
  ...
  var $mdgriffith$style_elements$Element$Attributes$fill =
    $mdgriffith$style_elements$Style$Internal$Model$Fill(1)
  var $author$project$Main$LogoStyle = { $: "LogoStyle" }
  var $mdgriffith$style_elements$Element$Internal$Model$Bold = { $: "Bold" }
  var $mdgriffith$style_elements$Element$bold =
    $mdgriffith$style_elements$Element$Internal$Model$Text({
      decoration: $mdgriffith$style_elements$Element$Internal$Model$Bold,
      inline: false
    })
  var $author$project$Main$logo = A3(
    $mdgriffith$style_elements$Element$row,
    $author$project$Main$LogoStyle,
    _List_fromArray([$mdgriffith$style_elements$Element$Attributes$padding(20)]),
    _List_fromArray([
      $mdgriffith$style_elements$Element$text("A"),
      $mdgriffith$style_elements$Element$bold("maze"),
      $mdgriffith$style_elements$Element$text("ing Evening")
    ])
  )
  var $author$project$Main$signalRConnectivity = function (isSignalRConnected) {
    var statusSymbol = isSignalRConnected
      ? $mdgriffith$style_elements$Element$text("✅")
      : $mdgriffith$style_elements$Element$text("❌")
    return A3(
      $mdgriffith$style_elements$Element$el,
      $author$project$Main$NoStyle,
      _List_fromArray([$mdgriffith$style_elements$Element$Attributes$padding(10)]),
      statusSymbol
    )
  }
  var $mdgriffith$style_elements$Element$Internal$Model$Justify = { $: "Justify" }
  var $mdgriffith$style_elements$Element$Attributes$spread =
    $mdgriffith$style_elements$Element$Internal$Model$HAlign(
      $mdgriffith$style_elements$Element$Internal$Model$Justify
    )
  var $author$project$Main$head = function (model) {
    return A3(
      $mdgriffith$style_elements$Element$row,
      $author$project$Main$NoStyle,
      _List_fromArray([
      ...
      _List_fromArray([
        ...
        $author$project$Main$signalRConnectivity(model.isSignalRConnected)
      ])
    )
  }
  var $author$project$Main$layout = function (model) {
    return A3(
      ...
      $author$project$Main$NoStyle,
      _List_Nil,
      _List_fromArray([$author$project$Main$head(model), $author$project$Main$body(model)])
    )
  }
  var $mdgriffith$style_elements$Style$Internal$Model$Box = F4(function (a, b, c, d) {
    return { $: "Box", a: a, b: b, c: c, d: d }
  })
  var $mdgriffith$style_elements$Style$Internal$Model$Exact = F2(function (a, b) {
    ...
    return (
      ...
      ("px " +
        ($elm$core$String$fromFloat(b) +
          ("px " +
            ($elm$core$String$fromFloat(c) + ("px " + ($elm$core$String$fromFloat(d) + "px"))))))
    )
  }
  ...
  var $mdgriffith$style_elements$Style$Internal$Model$Font = F2(function (a, b) {
    return { $: "Font", a: a, b: b }
  })
  var $mdgriffith$style_elements$Style$Font$center = A2(
    $mdgriffith$style_elements$Style$Internal$Model$Font,
    "text-align",
    "center"
  )
  var $mdgriffith$style_elements$Style$Internal$Model$RGBA = F4(function (a, b, c, d) {
    return { $: "RGBA", a: a, b: b, c: c, d: d }
  })
  var $mdgriffith$style_elements$Style$rgb = F3(function (r, g, b) {
  ...
  var $mdgriffith$style_elements$Style$Internal$Model$Style = F2(function (a, b) {
    return { $: "Style", a: a, b: b }
  })
  var $mdgriffith$style_elements$Style$Internal$Batchable$One = function (a) {
    return { $: "One", a: a }
  }
  var $mdgriffith$style_elements$Style$Internal$Batchable$one =
    $mdgriffith$style_elements$Style$Internal$Batchable$One
  var $mdgriffith$style_elements$Style$prop = F2(function (name, val) {
    return A2($mdgriffith$style_elements$Style$Internal$Model$Exact, name, val)
  })
  var $mdgriffith$style_elements$Style$style = F2(function (cls, props) {
  ...
  var $mdgriffith$style_elements$Style$Internal$Find$style = F2(function (_class, elements) {
    ...
    var found = $elm$core$List$head(A2($elm$core$List$filterMap, find, elements))
    if (found.$ === "Nothing") {
      return ""
    } else {
      var cls = found.a
  ...
  var $mdgriffith$style_elements$Style$Internal$Find$variation = F3(function (
    _class,
    vary,
    elements
  ) {
    var find = function (el) {
      if (el.$ === "Variation") {
        ...
        var _var = el.b
        var name = el.c
        return _Utils_eq(_class, cls) && _Utils_eq(_var, vary)
  ...
  var $mdgriffith$style_elements$Style$prepareSheet = function (_v0) {
    ...
    var variations = F2(function (_class, vs) {
      ...
      return A2($elm$core$List$cons, _Utils_Tuple2(parent, true), varys)
    })
    return {
      css: css,
      ...
      variations: F2(function (_class, varys) {
              ...
              $elm$core$List$head(
                $elm$core$List$reverse(
                  A2(
                    ...
                    $mdgriffith$style_elements$Style$Internal$Selector$getFindable,
                    selectors
                  )
                )
              )
  ...
  var $mdgriffith$style_elements$Style$Internal$Intermediate$RenderableClass = F2(function (a, b) {
  ...
  var $mdgriffith$style_elements$Style$Internal$Intermediate$RenderableMedia = F3(function (
    a,
    b,
    c
  ) {
  ...
  var $mdgriffith$style_elements$Style$Internal$Selector$render = F2(function (
    maybeGuard,
    selector
  ) {
    ...
    switch (selector.$) {
      ...
      case "SelectChild":
        ...
        return (
          "> " +
          A2($mdgriffith$style_elements$Style$Internal$Selector$render, maybeGuard, selectChild)
        )
      case "Free":
        var single = selector.a
        return single
      ...
      default:
        var sels = selector.a
        return $elm$core$String$concat(A2($elm$core$List$indexedMap, renderAndSpace, sels))
    }
  })
      ...
      case "Class":
        ...
        return A2(
          ...
          A2(
            ...
            A2(
              $mdgriffith$style_elements$Style$Internal$Selector$render,
              $elm$core$Maybe$Nothing,
              classRule.selector
            ),
            rendered
  ...
  var $mdgriffith$style_elements$Style$Internal$Render$Css$brace = F2(function (i, str) {
    return " {\n" + (str + ("\n" + (A2($elm$core$String$repeat, i, " ") + "}")))
  })
  var $mdgriffith$style_elements$Style$Internal$Render$Css$prop = F2(function (i, _v0) {
    var name = _v0.a
    var value = _v0.b
  ...
  var $mdgriffith$style_elements$Style$Internal$Intermediate$finalize = function (intermediates) {
    ...
    return $mdgriffith$style_elements$Style$Internal$Intermediate$Rendered({
      css: A2($elm$core$String$join, "\n", A2($elm$core$List$map, finalizeCss, intermediates)),
      findable: A2(
        $elm$core$List$concatMap,
        $mdgriffith$style_elements$Style$Internal$Intermediate$asFindable,
        intermediates
      )
    })
  }
  ...
  var $mdgriffith$style_elements$Style$Internal$Model$RotateAround = F4(function (a, b, c, d) {
    return { $: "RotateAround", a: a, b: b, c: c, d: d }
  })
  var $mdgriffith$style_elements$Style$Internal$Model$Scale = F3(function (a, b, c) {
  ...
  var $mdgriffith$style_elements$Style$Internal$Model$Translate = F3(function (a, b, c) {
  ...
  var $elm$core$List$partition = F2(function (pred, list) {
    var step = F2(function (x, _v0) {
      ...
      var falses = _v0.b
      return pred(x)
        ? _Utils_Tuple2(A2($elm$core$List$cons, x, trues), falses)
        : _Utils_Tuple2(trues, A2($elm$core$List$cons, x, falses))
    })
  ...
  var $mdgriffith$style_elements$Style$Internal$Render$preprocess = function (style) {
    if (style.$ === "Style") {
      ...
      var prioritize = F2(function (isPriority, priorityProps) {
        var _v9 = A2($elm$core$List$partition, isPriority, priorityProps)
        var high = _v9.a
        var low = _v9.b
      ...
      var overridePrevious = F2(function (overridable, overrideProps) {
        var eliminatePrevious = F2(function (prop, _v8) {
          ...
          return overridable(prop) && overridden
            ? _Utils_Tuple2(existing, overridden)
            : overridable(prop) && !overridden
            ? _Utils_Tuple2(A2($elm$core$List$cons, prop, existing), true)
            : _Utils_Tuple2(A2($elm$core$List$cons, prop, existing), overridden)
        })
        return A3(
          $elm$core$List$foldr,
          eliminatePrevious,
      ...
      var mergeTransforms = function (mergeableProps) {
        ...
        var gatherTransforms = F2(function (prop, _v5) {
          ...
          if (prop.$ === "Transform") {
            ...
            return _Utils_Tuple2(transforms, A2($elm$core$List$cons, prop, gatheredProps))
          }
        })
        var applyTransforms = function (_v3) {
          var rotate = _v3.a.rotate
          var scale = _v3.a.scale
          var translate = _v3.a.translate
          var gathered = _v3.b
          var transformations = A2(
            $elm$core$List$filterMap,
            $elm$core$Basics$identity,
            _List_fromArray([translate, rotate, scale])
          )
          return $elm$core$List$isEmpty(transformations)
            ? gathered
            : A2(
                $elm$core$List$cons,
        ...
        mergeShadowsAndFilters(
          A2(
            ...
            A2(
              prioritize,
              shadows,
              A2(overridePrevious, visible, A2(prioritize, visible, styleProps))
            )
          )
        )
      )
  ...
  var $mdgriffith$style_elements$Style$Internal$Render$class = F2(function (name, props) {
    var renderedProps = A2(
      $elm$core$String$join,
      "\n",
      A2($elm$core$List$map, $mdgriffith$style_elements$Style$Internal$Render$Css$prop(2), props)
    )
    return (
      "." +
      (name + A2($mdgriffith$style_elements$Style$Internal$Render$Css$brace, 0, renderedProps))
    )
  })
  ...
  var $mdgriffith$style_elements$Style$Internal$Selector$Select = F2(function (a, b) {
  ...
  var $mdgriffith$style_elements$Style$Internal$Find$Style = F2(function (a, b) {
    return { $: "Style", a: a, b: b }
  })
  var $mdgriffith$style_elements$Style$Internal$Find$Variation = F3(function (a, b, c) {
    return { $: "Variation", a: a, b: b, c: c }
  })
  var $mdgriffith$style_elements$Style$Internal$Selector$guard = F2(function (
    guardingString,
    selector
  ) {
    ...
    var onFindable = function (findable) {
      if (findable.$ === "Style") {
        ...
        var name = findable.b
        return A2($mdgriffith$style_elements$Style$Internal$Find$Style, _class, addGuard(name))
      } else {
        var _class = findable.a
  ...
  var $mdgriffith$style_elements$Style$Internal$Intermediate$applyGuard = F2(function (
    guardString,
    _class
  ) {
    ...
    switch (_class.$) {
      case "Class":
        ...
        return $mdgriffith$style_elements$Style$Internal$Intermediate$Class({
          ...
          selector: A2(
            $mdgriffith$style_elements$Style$Internal$Selector$guard,
            guardString,
            cls.selector
          )
        })
  ...
  var $mdgriffith$style_elements$Style$Internal$Intermediate$calculateGuard = function (_class) {
    ...
    var asString = function (prop) {
      switch (prop.$) {
        case "Props":
          var ps = prop.a
          return $elm$core$String$concat(A2($elm$core$List$map, propToString, ps))
        case "SubClass":
          var embedded = prop.a
        ...
        case "PropsAndSub":
          ...
          var embedded = prop.b
          return _Utils_ap(
            $elm$core$String$concat(A2($elm$core$List$map, propToString, ps)),
    ...
    switch (_class.$) {
      case "Class":
        ...
        return $elm$core$String$concat(A2($elm$core$List$map, asString, classRule.props))
      case "Media":
        var mediaRule = _class.a
        return $elm$core$String$concat(A2($elm$core$List$map, asString, mediaRule.props))
      default:
        return ""
    }
  }
      ...
      ? data.seed ^
        A2(
          ...
          A2(
            ...
            15,
            A2($robinheghan$murmur3$Murmur3$multiplyBy, $robinheghan$murmur3$Murmur3$c1, data.hash)
          )
        )
      : data.seed
          ...
          h1 ^
            A2(
              ...
              A2(
                $robinheghan$murmur3$Murmur3$rotlBy,
                15,
                A2($robinheghan$murmur3$Murmur3$multiplyBy, $robinheghan$murmur3$Murmur3$c1, k1)
              )
            )
        )
      ) + 3864292196
  ...
  var $mdgriffith$style_elements$Style$Internal$Intermediate$hash = function (value) {
    return $elm$core$String$fromInt(A2($robinheghan$murmur3$Murmur3$hashString, 8675309, value))
  }
  ...
  var $mdgriffith$style_elements$Style$Internal$Intermediate$PropsAndSub = F2(function (a, b) {
    return { $: "PropsAndSub", a: a, b: b }
  })
  var $mdgriffith$style_elements$Style$Internal$Intermediate$asMediaQuery = F2(function (
    query,
    prop
  ) {
  ...
  var $mdgriffith$style_elements$Style$Internal$Render$Value$length = function (l) {
    switch (l.$) {
      ...
      default:
        ...
        return (
          "calc(" +
          ($elm$core$String$fromFloat(perc) + ("% + " + ($elm$core$String$fromFloat(px) + "px)")))
        )
    }
  }
  var $mdgriffith$style_elements$Style$Internal$Render$Property$background = function (prop) {
    var renderStep = function (step) {
      switch (step.$) {
        ...
        default:
          ...
          return (
            $mdgriffith$style_elements$Style$Internal$Render$Value$color(color) +
            (" " + ($elm$core$String$fromFloat(percent) + "px"))
          )
      }
    }
    ...
    switch (prop.$) {
      case "BackgroundElement":
        var name = prop.a
        var val = prop.b
        return _List_fromArray([_Utils_Tuple2(name, val)])
      case "BackgroundImage":
        ...
        return _List_fromArray([
          ...
          _Utils_Tuple2(
            "background-position",
            $elm$core$String$fromFloat(image.position.a) +
              ("px " + ($elm$core$String$fromFloat(image.position.b) + "px"))
          ),
          _Utils_Tuple2(
            "background-repeat",
            (function () {
              var _v1 = image.repeat
              switch (_v1.$) {
                case "RepeatX":
                  return "repeat-x"
                case "RepeatY":
            ...
            (function () {
              ...
              switch (_v2.$) {
                ...
                case "BackgroundWidth":
                  var width = _v2.a
                  return (
                    $mdgriffith$style_elements$Style$Internal$Render$Value$length(width) + " auto"
                  )
                case "BackgroundHeight":
                  var height = _v2.a
                  return (
                    "auto " + $mdgriffith$style_elements$Style$Internal$Render$Value$length(height)
                  )
                default:
                  var width = _v2.a.width
                  var height = _v2.a.height
                  return (
                    $mdgriffith$style_elements$Style$Internal$Render$Value$length(width) +
                    (" " + $mdgriffith$style_elements$Style$Internal$Render$Value$length(height))
                  )
              }
            })()
          )
  ...
  var $mdgriffith$style_elements$Style$Internal$Selector$child = F2(function (parent, selector) {
    return $mdgriffith$style_elements$Style$Internal$Selector$Stack(
      _List_fromArray([
        parent,
    ...
    return A2(
      ...
      A2(
        ...
        _List_fromArray([
          ...
          $elm$core$Maybe$Just($elm$core$String$fromFloat(shadowModel.offset.a) + "px"),
          $elm$core$Maybe$Just($elm$core$String$fromFloat(shadowModel.offset.b) + "px"),
          $elm$core$Maybe$Just($elm$core$String$fromFloat(shadowModel.blur) + "px"),
          shadowModel.kind === "text" || shadowModel.kind === "drop"
            ? $elm$core$Maybe$Nothing
            : $elm$core$Maybe$Just($elm$core$String$fromFloat(shadowModel.size) + "px"),
          $elm$core$Maybe$Just(
    ...
    var filterName = function (filtr) {
      switch (filtr.$) {
        ...
        default:
          ...
          return (
            "drop-shadow(" +
            ($mdgriffith$style_elements$Style$Internal$Render$Value$shadow(shadowModel) + ")")
          )
      }
    }
    return !$elm$core$List$length(myFilters)
      ? _List_Nil
      : _List_fromArray([
          _Utils_Tuple2(
            "filter",
            A2($elm$core$String$join, " ", A2($elm$core$List$map, filterName, myFilters))
          )
        ])
  }
      ...
      switch (prop.$) {
        ...
        case "SubClass":
          if (prop.a.$ === "Class") {
            ...
            return A2(
              $elm$core$List$concatMap,
              $mdgriffith$style_elements$Style$Internal$Intermediate$getProps,
              myClass.props
            )
          } else {
            break _v0$4
  ...
  var $mdgriffith$style_elements$Style$Internal$Render$Property$flexbox = F2(function (dir, el) {
    switch (el.$) {
      case "Wrap":
        var wrap = el.a
  ...
  var $mdgriffith$style_elements$Style$Internal$Render$Property$layout = F2(function (inline, lay) {
    switch (lay.$) {
      case "TextLayout":
        return _List_fromArray([_Utils_Tuple2("display", inline ? "inline-block" : "block")])
      case "FlexLayout":
        var dir = lay.a
        var flexProps = lay.b
        return A2(
          $elm$core$List$cons,
          _Utils_Tuple2("display", inline ? "inline-flex" : "flex"),
          A2(
            $elm$core$List$cons,
      ...
      default:
        if (lay.a.$ === "NamedGridTemplate") {
          ...
          var renderLen = function (len) {
            switch (len.$) {
              ...
              default:
                ...
                return (
                  "calc(" +
                  ($elm$core$String$fromFloat(perc) +
                    ("% + " + ($elm$core$String$fromFloat(px) + "px)")))
                )
            }
          }
          var grid = inline
            ? _Utils_Tuple2("display", "inline-grid")
          ...
          var areaSpan = function (_v3) {
            ...
            if (span.$ === "SpanAll") {
              return A2($elm$core$List$repeat, $elm$core$List$length(columns), name)
            } else {
              var i = span.a
          ...
          var areasInRow = function (areas) {
            ...
            return _Utils_cmp($elm$core$List$length(areaStrs), $elm$core$List$length(columns)) > 0
              ? quote(A2($elm$core$String$join, " ", areaStrs))
              : _Utils_cmp($elm$core$List$length(areaStrs), $elm$core$List$length(columns)) < 0
              ? quote(A2($elm$core$String$join, " ", areaStrs))
              : quote(A2($elm$core$String$join, " ", areaStrs))
          }
          var alignment = A2(
            $elm$core$List$map,
            $mdgriffith$style_elements$Style$Internal$Render$Property$gridAlignment,
            options
          )
          return A2(
            $elm$core$List$cons,
            ...
            A2(
              ...
              A2(
                ...
                _Utils_Tuple2(
                  ...
                  A2($elm$core$String$join, " ", A2($elm$core$List$map, renderLen, columns))
                ),
                A2(
                  $elm$core$List$cons,
                  _Utils_Tuple2(
          ...
          return A2(
            ...
            A2(
              ...
              _Utils_Tuple2(
                "grid-template-rows",
                A2($elm$core$String$join, " ", A2($elm$core$List$map, renderLen, rows))
              ),
              A2(
                $elm$core$List$cons,
                _Utils_Tuple2(
  ...
  var $mdgriffith$style_elements$Style$Internal$Intermediate$props =
  ...
  var $mdgriffith$style_elements$Style$Internal$Selector$pseudo = F2(function (psu, sel) {
    switch (sel.$) {
      case "Pseudo":
        var existing = sel.a
      ...
      default:
        ...
        var init = $elm$core$List$reverse(A2($elm$core$List$drop, 1, $elm$core$List$reverse(sels)))
        if (lastElem.$ === "Nothing") {
  ...
  var $mdgriffith$style_elements$Style$Internal$Render$Property$shadow = function (shadows) {
    ...
    var renderedBox = A2(
      ...
      A2(
        $elm$core$List$map,
        $mdgriffith$style_elements$Style$Internal$Render$Value$shadow,
        boxShadow
      )
    )
    var renderedText = A2(
    ...
    return A2(
      ...
      _List_fromArray([
        renderedBox === ""
          ? $elm$core$Maybe$Nothing
          : $elm$core$Maybe$Just(_Utils_Tuple2("box-shadow", renderedBox)),
        renderedText === ""
          ? $elm$core$Maybe$Nothing
          : $elm$core$Maybe$Just(_Utils_Tuple2("text-shadow", renderedText))
      ])
    )
  }
  var $mdgriffith$style_elements$Style$Internal$Render$Property$transformations = function (
    transforms
  ) {
      ...
      switch (transform.$) {
        ...
        default:
          ...
          return (
            ...
            ($elm$core$String$fromFloat(x) +
              (", " +
                ($elm$core$String$fromFloat(y) + (", " + ($elm$core$String$fromFloat(z) + ")")))))
          )
      }
    }
    ...
    var renderedTransforms =
      $elm$core$String$length(transformString) > 0
        ? _List_fromArray([_Utils_Tuple2("transform", transformString)])
        : _List_Nil
  ...
  var $mdgriffith$style_elements$Style$Internal$Render$Property$transition = function (_v0) {
    ...
    var easing = _v0.a.easing
    var props = _v0.a.props
    ...
    return A2($elm$core$String$join, ", ", A2($elm$core$List$map, formatTrans, props))
  }
  var $mdgriffith$style_elements$Style$Internal$Render$Value$typeface = function (families) {
    ...
    return A2($elm$core$String$join, ", ", A2($elm$core$List$map, renderFont, families))
  }
  var $mdgriffith$style_elements$Style$Internal$Render$Property$visibility = function (vis) {
    switch (vis.$) {
      case "Hidden":
        return _List_fromArray([_Utils_Tuple2("display", "none")])
      case "Invisible":
        return _List_fromArray([_Utils_Tuple2("visibility", "hidden")])
      default:
        var x = vis.a
        return _List_fromArray([_Utils_Tuple2("opacity", $elm$core$String$fromFloat(x))])
    }
  }
  var $mdgriffith$style_elements$Style$Internal$Render$renderVariationProp = F2(function (
    parentClass,
    prop
  ) {
    switch (prop.$) {
      ...
      case "PseudoElement":
        ...
        return A2(
          ...
          A2(
            $elm$core$Basics$composeL,
            $elm$core$Maybe$Just,
            $mdgriffith$style_elements$Style$Internal$Intermediate$SubClass
          ),
      ...
      case "Exact":
        ...
        return A2(
          ...
          $elm$core$Maybe$Just,
          $mdgriffith$style_elements$Style$Internal$Intermediate$props
        )(_List_fromArray([_Utils_Tuple2(name, val)]))
      case "Visibility":
        var vis = prop.a
        return A3(
          $elm$core$Basics$composeL,
      ...
      case "SelectionColor":
        ...
        return A2(
          ...
          selector: A2(
            $mdgriffith$style_elements$Style$Internal$Selector$pseudo,
            "::selection",
            parentClass
          )
        })
            ...
            _List_fromArray([
              _Utils_Tuple2(
                ...
                A2(
                  ...
                  A2(
                    $elm$core$List$map,
                    $mdgriffith$style_elements$Style$Internal$Render$Property$transition,
                    trans
                  )
                )
              )
  ...
  var $mdgriffith$style_elements$Style$Internal$Selector$uncapitalize = function (str) {
    ...
    var head = $elm$core$String$toLower(A2($elm$core$String$left, 1, str))
  ...
  var $mdgriffith$style_elements$Style$Internal$Find$toVariation = F3(function (
    _var,
    newName,
    element
  ) {
  ...
  var $mdgriffith$style_elements$Style$Internal$Selector$variant = F3(function (sel, _var, name) {
    switch (sel.$) {
      case "Pseudo":
        var psu = sel.a
  ...
  var $mdgriffith$style_elements$Style$Internal$Render$renderProp = F2(function (
    parentClass,
    prop
  ) {
    switch (prop.$) {
      ...
      case "Variation":
        ...
        var selectVariation = A3(
          $mdgriffith$style_elements$Style$Internal$Selector$variant,
          parentClass,
          _var,
          variationName
        )
  ...
  var $mdgriffith$style_elements$Style$Internal$Render$renderStyle = F2(function (guarded, style) {
    switch (style.$) {
      case "Reset":
        var reset = style.a
  ...
  var $mdgriffith$style_elements$Style$Internal$Render$reorderImportAddReset = F2(function (
    reset,
    styles
  ) {
    var reorder = F2(function (style, _v5) {
      ...
      if (style.$ === "Import") {
        return _Utils_Tuple2(A2($elm$core$List$cons, style, importStatements), remainingStyles)
      } else {
        var x = style
        return _Utils_Tuple2(importStatements, A2($elm$core$List$cons, style, remainingStyles))
      }
    })
    ...
    var _v0 = A3($elm$core$List$foldr, reorder, _Utils_Tuple2(_List_Nil, _List_Nil), styles)
    var imports = _v0.a
    var allStyles = _v0.b
    return _Utils_ap(
      imports,
      _Utils_ap(
        importedFonts,
        _Utils_ap(
          _List_fromArray([$mdgriffith$style_elements$Style$Internal$Model$Reset(reset)]),
          allStyles
        )
      )
    )
  ...
  var $mdgriffith$style_elements$Style$Internal$Render$stylesheet = F3(function (
    reset,
    guard,
    batched
  ) {
  ...
  var $mdgriffith$style_elements$Style$styleSheetWith = F2(function (options, styles) {
    var unguard = A2(
      $elm$core$List$any,
  ...
  var $author$project$Main$stylesheet = $mdgriffith$style_elements$Style$styleSheet(
    _List_fromArray([
      A2($mdgriffith$style_elements$Style$style, $author$project$Main$NoStyle, _List_Nil),
      A2(
        $mdgriffith$style_elements$Style$style,
        $author$project$Main$LogoStyle,
        _List_fromArray([$mdgriffith$style_elements$Style$Font$size(30)])
      ),
      A2(
        $mdgriffith$style_elements$Style$style,
        $author$project$Main$RowStyle($author$project$Main$Even),
        _List_fromArray([
          $mdgriffith$style_elements$Style$Color$background(
            A3($mdgriffith$style_elements$Style$rgb, 0.6, 0.9, 0.9)
          ),
          $mdgriffith$style_elements$Style$Border$bottom(0.9)
        ])
      ),
      A2(
        $mdgriffith$style_elements$Style$style,
        $author$project$Main$RowStyle($author$project$Main$Odd),
        _List_fromArray([
          $mdgriffith$style_elements$Style$Color$background(
            A3($mdgriffith$style_elements$Style$rgb, 0.95, 0.95, 0.95)
          ),
          $mdgriffith$style_elements$Style$Border$bottom(0.9)
        ])
      ),
      A2(
        ...
        $author$project$Main$MazeBackground,
        _List_fromArray([
          $mdgriffith$style_elements$Style$Border$all(0.9),
          $mdgriffith$style_elements$Style$Color$background(
            A3($mdgriffith$style_elements$Style$rgb, 0.9, 0.9, 0.9)
          )
        ])
      ),
      A2(
        ...
        _List_fromArray([
          $mdgriffith$style_elements$Style$Color$background(
            A3($mdgriffith$style_elements$Style$rgb, 0.0, 0.5, 0.8)
          )
        ])
      ),
      A2(
        ...
        _List_fromArray([
          $mdgriffith$style_elements$Style$Color$background(
            A3($mdgriffith$style_elements$Style$rgb, 0.0, 0.7, 0.2)
          )
        ])
      ),
      A2(
        ...
        _List_fromArray([
          $mdgriffith$style_elements$Style$Color$background(
            A3($mdgriffith$style_elements$Style$rgb, 0.7, 0.2, 0.2)
          )
        ])
      ),
      A2(
        $mdgriffith$style_elements$Style$style,
        $author$project$Main$MazeName,
        _List_fromArray([$mdgriffith$style_elements$Style$Font$center])
      ),
      A2(
        $mdgriffith$style_elements$Style$style,
        $author$project$Main$InvocationsText,
        _List_fromArray([$mdgriffith$style_elements$Style$Font$size(10)])
      ),
      A2(
        $mdgriffith$style_elements$Style$style,
        $author$project$Main$PlayerIdText,
  ...
  var $mdgriffith$style_elements$Element$Internal$Render$miniNormalize =
    ...
    $mdgriffith$style_elements$Element$Internal$Render$withFocus
  ...
  var $mdgriffith$style_elements$Element$Internal$Render$embed = F2(function (full, stylesheet) {
    return _List_fromArray([
      A3(
        $elm$html$Html$node,
        "style",
          ...
          $elm$html$Html$text(
            full
              ? "html,body{width:100%;height:100%;}" +
                  $mdgriffith$style_elements$Element$Internal$Render$miniNormalize
              : $mdgriffith$style_elements$Element$Internal$Render$miniNormalize
          )
        ])
      ),
      A3(
        ...
        "style",
        _List_Nil,
        _List_fromArray([$elm$html$Html$text(stylesheet.css)])
      )
    ])
  })
  ...
  var $mdgriffith$style_elements$Element$Internal$Model$adjust = F3(function (fn, parent, elemen) {
    ...
    switch (elemen.$) {
      case "Element":
        ...
        var adjustAndMerge = F2(function (el, _v8) {
          ...
          var _v6 = A3(
            $mdgriffith$style_elements$Element$Internal$Model$adjust,
            fn,
            $elm$core$Maybe$Nothing,
            el
          )
        ...
        var _v1 = (function () {
          if (absolutelyPositioned.$ === "Nothing") {
            ...
            return (function (_v3) {
              ...
              A3($elm$core$List$foldr, adjustAndMerge, _Utils_Tuple2(_List_Nil, _List_Nil), others)
            )
          }
        })()
        ...
        var _v5 = A2(
          ...
          $mdgriffith$style_elements$Element$Internal$Model$Element(
            _Utils_update(elm, { absolutelyPositioned: adjustedOthers, child: adjustedChild })
          )
        )
        ...
        return _Utils_Tuple2(
          ...
          A3(
            ...
            merge,
            $elm$core$Maybe$Nothing,
            _List_fromArray([childData, otherChildrenData, elData])
          )
        )
      case "Layout":
        var elm = elemen.a
        var adjustAndMergeKeyed = F3(function (usingParent, _v22, _v23) {
          ...
          if (data.$ === "Nothing") {
            return _Utils_Tuple2(
              A2($elm$core$List$cons, _Utils_Tuple2(key, adjusted), adjustedAggregate),
              dataAggregate
            )
          } else {
            var d = data.a
        ...
        var _v9 = (function () {
          var _v10 = elm.absolutelyPositioned
          if (_v10.$ === "Nothing") {
            return _Utils_Tuple2($elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing)
          } else {
            var others = _v10.a
        ...
        var _v12 = (function () {
          var _v13 = elm.children
          if (_v13.$ === "Normal") {
            var normalChildren = _v13.a
            var _v14 = A3(
              $elm$core$List$foldr,
              adjustAndMerge($elm$core$Maybe$Just(elm.layout)),
              _Utils_Tuple2(_List_Nil, _List_Nil),
              normalChildren
            )
            var adjusted = _v14.a
            ...
            var _v15 = A3(
              $elm$core$List$foldr,
              adjustAndMergeKeyed($elm$core$Maybe$Just(elm.layout)),
              _Utils_Tuple2(_List_Nil, _List_Nil),
              keyedChildren
            )
            var adjusted = _v15.a
        ...
        var _v16 = A2(
          ...
          $mdgriffith$style_elements$Element$Internal$Model$Layout(
            _Utils_update(elm, { absolutelyPositioned: adjustedOthers, children: adjustedChildren })
          )
        )
        ...
        return _Utils_Tuple2(
          ...
          A3(
            ...
            merge,
            $elm$core$Maybe$Nothing,
            _List_fromArray([layoutData, childrenData, otherChildrenData])
          )
        )
      default:
  ...
  var $mdgriffith$style_elements$Element$Internal$Adjustments$tag = function (str) {
    return $mdgriffith$style_elements$Element$Internal$Adjustments$tagIntermediates
      ? $mdgriffith$style_elements$Element$Internal$Model$Attr($elm$html$Html$Attributes$class(str))
      : $mdgriffith$style_elements$Element$Internal$Model$Attr($elm$html$Html$Attributes$class(""))
  }
  var $mdgriffith$style_elements$Element$Internal$Adjustments$centerTextLayout = function (elm) {
    if (elm.$ === "Layout") {
        ...
        function (attr) {
          return (
            _Utils_eq(
              attr,
              $mdgriffith$style_elements$Element$Internal$Model$HAlign(
                $mdgriffith$style_elements$Element$Internal$Model$Center
              )
            ) ||
            _Utils_eq(
              attr,
      ...
      if (layout.$ === "TextLayout") {
        return !$elm$core$List$isEmpty(centeredProps)
          ? $mdgriffith$style_elements$Element$Internal$Model$Layout({
              absolutelyPositioned: $elm$core$Maybe$Nothing,
              attrs: A2(
                $elm$core$List$cons,
  ...
  var $mdgriffith$style_elements$Element$Internal$Adjustments$hoistFixedScreenElements = function (
    el
  ) {
        ...
        function (attr) {
          return _Utils_eq(
            ...
            $mdgriffith$style_elements$Element$Internal$Model$PositionFrame(
              $mdgriffith$style_elements$Element$Internal$Model$Screen
            )
          )
        },
        attrs
    ...
    switch (el.$) {
      case "Element":
        ...
        return elementIsOnScreen(attrs)
          ? _Utils_Tuple2(
              $mdgriffith$style_elements$Element$Internal$Model$Empty,
              $elm$core$Maybe$Just(_List_fromArray([el]))
            )
          : _Utils_Tuple2(el, $elm$core$Maybe$Nothing)
      case "Layout":
        var attrs = el.a.attrs
        return elementIsOnScreen(attrs)
          ? _Utils_Tuple2(
  ...
  var $mdgriffith$style_elements$Element$Internal$Model$Position = F3(function (a, b, c) {
  ...
  var $mdgriffith$style_elements$Element$Internal$Modify$addAttrList = F2(function (props, el) {
    switch (el.$) {
      case "Empty":
  ...
  var $mdgriffith$style_elements$Element$Internal$Modify$addAttrPriority = F2(function (prop, el) {
    switch (el.$) {
      case "Empty":
        return $mdgriffith$style_elements$Element$Internal$Model$Empty
      case "Raw":
      ...
      case "Layout":
        ...
        return $mdgriffith$style_elements$Element$Internal$Model$Layout(
          _Utils_update(elm, {
            attrs: _Utils_ap(elm.attrs, _List_fromArray([prop]))
          })
        )
      case "Element":
        var elm = el.a
  ...
  var $mdgriffith$style_elements$Style$Internal$Model$Calc = F2(function (a, b) {
    return { $: "Calc", a: a, b: b }
  })
  var $mdgriffith$style_elements$Element$Internal$Model$Margin = F4(function (a, b, c, d) {
    return { $: "Margin", a: a, b: b, c: c, d: d }
  })
  var $mdgriffith$style_elements$Element$Internal$Model$PhantomPadding = F4(function (a, b, c, d) {
    return { $: "PhantomPadding", a: a, b: b, c: c, d: d }
  })
  var $mdgriffith$style_elements$Element$Internal$Model$Shrink = function (a) {
    return { $: "Shrink", a: a }
  }
  var $mdgriffith$style_elements$Element$Internal$Modify$addAttr = F2(function (prop, el) {
    switch (el.$) {
      case "Empty":
        return $mdgriffith$style_elements$Element$Internal$Model$Empty
      case "Raw":
  ...
  var $mdgriffith$style_elements$Element$Internal$Adjustments$counterSpacing = function (elm) {
    if (elm.$ === "Layout") {
      ...
      var spacing = $elm$core$List$head(
        $elm$core$List$reverse(A2($elm$core$List$filterMap, forSpacing, attrs))
      )
      ...
      var phantomPadding = A2(
        ...
        $elm$core$List$head(
          $elm$core$List$reverse(A2($elm$core$List$filterMap, forPhantomPadding, attrs))
        )
      )
      var _v1 = A2(
        $elm$core$List$partition,
      ...
      if (layout.$ === "FlexLayout") {
        if (hasSpacing) {
          ...
          var _v3 = A2($elm$core$List$partition, forAlignment, attrs)
          var aligned = _v3.a
          var unaligned = _v3.b
          var _v4 = (function () {
            if (spacing.$ === "Nothing") {
              ...
              return _Utils_Tuple3(
                A4(
                  $mdgriffith$style_elements$Element$Internal$Model$Margin,
                  -1 * y,
                  -1 * x,
                  -1 * y,
                  -1 * x
          ...
          return $mdgriffith$style_elements$Element$Internal$Model$Layout({
            ...
            attrs: A2(
              $elm$core$List$cons,
              $mdgriffith$style_elements$Element$Internal$Adjustments$tag(
                "counter-spacing-container"
              ),
              A2(
                $elm$core$List$cons,
                $mdgriffith$style_elements$Element$Internal$Model$PointerEvents(true),
                        ...
                        A2(
                          ...
                          A2(
                            ...
                            A2(
                              ...
                              $mdgriffith$style_elements$Element$Internal$Model$Width(
                                A2(
                                  $mdgriffith$style_elements$Style$Internal$Model$Calc,
                                  100,
                                  totalHSpacing
                                )
                              ),
  ...
  var $mdgriffith$style_elements$Element$Internal$Modify$setAttrs = F2(function (props, el) {
    switch (el.$) {
      case "Empty":
        return $mdgriffith$style_elements$Element$Internal$Model$Empty
      case "Spacer":
  ...
  var $mdgriffith$style_elements$Element$Internal$Adjustments$positionNearby = F2(function (
    parent,
    elm
  ) {
    var setPosition = F3(function (nearbyPosition, _v24, el) {
          ...
          if (nearbyPosition.$ === "Just" && nearbyPosition.a.$ === "Nearby") {
            switch (nearbyPosition.a.a.$) {
              case "Above":
                ...
                return _List_fromArray([
                  $mdgriffith$style_elements$Element$Internal$Model$VAlign(
                    $mdgriffith$style_elements$Element$Internal$Model$Top
                  )
                ])
              case "Below":
              ...
              case "OnLeft":
                ...
                return _List_fromArray([
                  $mdgriffith$style_elements$Element$Internal$Model$HAlign(
                    $mdgriffith$style_elements$Element$Internal$Model$Left
                  )
                ])
              default:
                break _v19$4
      ...
      var width = $elm$core$List$head(
        $elm$core$List$reverse(A2($elm$core$List$filter, forWidth, unaligned))
      )
      ...
      var height = $elm$core$List$head(
        $elm$core$List$reverse(A2($elm$core$List$filter, forHeight, unaligned))
      )
      ...
      var addWidthHeight = function (attrs) {
        ...
        if (_v8.a.$ === "Nothing") {
          ...
          if (_v8.b.$ === "Just") {
            var w = _v8.a.a
            var h = _v8.b.a
            return A2($elm$core$List$cons, w, A2($elm$core$List$cons, h, attrs))
          } else {
            var w = _v8.a.a
            var _v12 = _v8.b
      ...
      return _Utils_eq(
        nearbyPosition,
        $elm$core$Maybe$Just(
          $mdgriffith$style_elements$Element$Internal$Model$Nearby(
            $mdgriffith$style_elements$Element$Internal$Model$Above
          )
        )
      ) ||
        _Utils_eq(
          ...
          $elm$core$Maybe$Just(
            $mdgriffith$style_elements$Element$Internal$Model$Nearby(
              $mdgriffith$style_elements$Element$Internal$Model$Below
            )
          )
        )
        ? $mdgriffith$style_elements$Element$Internal$Model$Layout({
            ...
            attrs: A2(
              $elm$core$List$cons,
              $mdgriffith$style_elements$Element$Internal$Adjustments$tag(
                "above-below-intermediate-parent"
              ),
              A2(
                $elm$core$List$cons,
                $mdgriffith$style_elements$Element$Internal$Model$PointerEvents(false),
                      ...
                      $mdgriffith$style_elements$Element$Internal$Model$PositionFrame(
                        $mdgriffith$style_elements$Element$Internal$Model$Absolute(
                          _Utils_eq(
                            ...
                            ? $mdgriffith$style_elements$Element$Internal$Model$TopLeft
                            : $mdgriffith$style_elements$Element$Internal$Model$BottomLeft
                        )
                      ),
                      A2(
                        $elm$core$List$cons,
                ...
                $mdgriffith$style_elements$Element$Internal$Model$Element({
                  ...
                  attrs: addWidthHeight(
                    _List_fromArray([
                      $mdgriffith$style_elements$Element$Internal$Model$PointerEvents(false),
                      $mdgriffith$style_elements$Element$Internal$Model$PositionFrame(
                        $mdgriffith$style_elements$Element$Internal$Model$Relative
                      ),
                      A3(
                        $mdgriffith$style_elements$Element$Internal$Model$Position,
                        $elm$core$Maybe$Just(0),
        ...
        : !$elm$core$List$isEmpty(aligned)
        ? $mdgriffith$style_elements$Element$Internal$Model$Layout({
            absolutelyPositioned: $elm$core$Maybe$Nothing,
            attrs: A2(
              $elm$core$List$cons,
              $mdgriffith$style_elements$Element$Internal$Adjustments$tag(
                "nearby-aligned-intermediate-parent"
              ),
              A2(
                $elm$core$List$cons,
                $mdgriffith$style_elements$Element$Internal$Model$PointerEvents(false),
    ...
    switch (elm.$) {
      case "Element":
        ...
        var frame = $elm$core$List$head(A2($elm$core$List$filterMap, isFrame, attrs))
  ...
  var $mdgriffith$style_elements$Element$Internal$Render$defaultPadding = F2(function (_v0, _v1) {
    var mW = _v0.a
    var mX = _v0.b
    var mY = _v0.c
    var mZ = _v0.d
  ...
  var $mdgriffith$style_elements$Element$Internal$Render$detectOrder = F2(function (list, i) {
    var len = $elm$core$List$length(list)
    return !i && len === 1
      ? $mdgriffith$style_elements$Element$Internal$Render$FirstAndLast
      : !i
      ? $mdgriffith$style_elements$Element$Internal$Render$First
      : _Utils_eq(i, len - 1)
      ? $mdgriffith$style_elements$Element$Internal$Render$Last
      : $mdgriffith$style_elements$Element$Internal$Render$Middle(i)
  })
  ...
  var $mdgriffith$style_elements$Element$Internal$Render$makePositionable = F2(function (
    attribute,
    pos
  ) {
    switch (attribute.$) {
      ...
      case "Inline":
        return _Utils_update(pos, { inline: true })
      case "Expand":
        return _Utils_update(pos, { expand: true })
      case "Vary":
        var vary = attribute.a
        var on = attribute.b
        return _Utils_update(pos, {
          variations: A2($elm$core$List$cons, _Utils_Tuple2(vary, on), pos.variations)
        })
      case "Height":
        var len = attribute.a
        return _Utils_update(pos, {
      ...
      case "Hidden":
        return _Utils_update(pos, { hidden: true })
      case "Opacity":
        var t = attribute.a
        return _Utils_update(pos, {
  ...
  var $mdgriffith$style_elements$Element$Internal$Render$gather = function (attrs) {
    return A3(
      $elm$core$List$foldl,
      $mdgriffith$style_elements$Element$Internal$Render$makePositionable,
      $mdgriffith$style_elements$Element$Internal$Render$emptyPositionable,
      attrs
    )
  }
  ...
  var $mdgriffith$style_elements$Style$Internal$Model$Grid = F2(function (a, b) {
    return { $: "Grid", a: a, b: b }
  })
  ...
  var $mdgriffith$style_elements$Element$Internal$Render$alignLayout = F3(function (
    maybeHorizontal,
    maybeVertical,
    layout
  ) {
      ...
      switch (align.$) {
        case "Top":
          return $mdgriffith$style_elements$Style$Internal$Model$GridV(
            $mdgriffith$style_elements$Style$Internal$Model$Other(
              $mdgriffith$style_elements$Style$Internal$Model$Top
            )
          )
        case "Bottom":
          return $mdgriffith$style_elements$Style$Internal$Model$GridV(
            $mdgriffith$style_elements$Style$Internal$Model$Other(
              $mdgriffith$style_elements$Style$Internal$Model$Bottom
            )
          )
        case "VerticalCenter":
          return $mdgriffith$style_elements$Style$Internal$Model$GridV(
            $mdgriffith$style_elements$Style$Internal$Model$Center
          )
        default:
          return $mdgriffith$style_elements$Style$Internal$Model$GridV(
            $mdgriffith$style_elements$Style$Internal$Model$Justify
          )
      }
    }
      ...
      switch (align.$) {
        case "Left":
          return $mdgriffith$style_elements$Style$Internal$Model$GridH(
            $mdgriffith$style_elements$Style$Internal$Model$Other(
              $mdgriffith$style_elements$Style$Internal$Model$Left
            )
          )
        case "Right":
          return $mdgriffith$style_elements$Style$Internal$Model$GridH(
            $mdgriffith$style_elements$Style$Internal$Model$Other(
              $mdgriffith$style_elements$Style$Internal$Model$Right
            )
          )
        case "Center":
          return $mdgriffith$style_elements$Style$Internal$Model$GridH(
        ...
        if (_v1.a.$ === "Nothing") {
          if (_v1.b.$ === "Nothing") {
            ...
            return A2(
              $mdgriffith$style_elements$Style$Internal$Model$FlexLayout,
              dir,
              A2($elm$core$List$cons, alignFlexboxVertical(v), els)
            )
          }
        } else {
          if (_v1.b.$ === "Nothing") {
            ...
            return A2(
              $mdgriffith$style_elements$Style$Internal$Model$FlexLayout,
              dir,
              A2($elm$core$List$cons, alignFlexboxHorizontal(h), els)
            )
          } else {
            var h = _v1.a.a
            var v = _v1.b.a
        ...
        if (_v6.a.$ === "Nothing") {
          if (_v6.b.$ === "Nothing") {
            ...
            return A2(
              ...
              template,
              A2($elm$core$List$cons, alignGridVertical(v), els)
            )
          }
        } else {
          if (_v6.b.$ === "Nothing") {
            ...
            return A2(
              $mdgriffith$style_elements$Style$Internal$Model$Grid,
              template,
              A2($elm$core$List$cons, alignGridHorizontal(h), els)
            )
          } else {
            var h = _v6.a.a
            var v = _v6.b.a
  ...
  var $mdgriffith$style_elements$Element$Internal$Render$calcPosition = F2(function (frame, _v0) {
    var mx = _v0.a
    var my = _v0.b
    var mz = _v0.c
            ...
            _List_fromArray([
              ...
              (function () {
                if (mx.$ === "Just") {
                  var xVal = mx.a
                  return $elm$core$Maybe$Just(
                    _Utils_Tuple2("left", $elm$core$String$fromFloat(xVal) + "px")
                  )
                } else {
                  return $elm$core$Maybe$Nothing
                }
              ...
              (function () {
                if (my.$ === "Just") {
                  var yVal = my.a
                  return $elm$core$Maybe$Just(
                    _Utils_Tuple2("top", $elm$core$String$fromFloat(yVal) + "px")
                  )
                } else {
                  return $elm$core$Maybe$Nothing
                }
            ...
            _List_fromArray([
              ...
              (function () {
                if (my.$ === "Just") {
                  var yVal = my.a
                  return $elm$core$Maybe$Just(
                    _Utils_Tuple2("bottom", $elm$core$String$fromFloat(yVal) + "px")
                  )
                } else {
                  return $elm$core$Maybe$Nothing
                }
  ...
  var $mdgriffith$style_elements$Style$Internal$Render$Property$flexHeight = function (l) {
    switch (l.$) {
      case "Px":
        var x = l.a
        return _List_fromArray([_Utils_Tuple2("height", $elm$core$String$fromFloat(x) + "px")])
      case "Percent":
        var x = l.a
        return _List_fromArray([_Utils_Tuple2("height", $elm$core$String$fromFloat(x) + "%")])
      case "Auto":
        return _List_fromArray([_Utils_Tuple2("height", "auto")])
      case "Fill":
        var i = l.a
        return _List_fromArray([
  ...
  var $mdgriffith$style_elements$Style$Internal$Render$Property$flexWidth = F2(function (
    len,
    adjustment
  ) {
    switch (len.$) {
      case "Px":
        var x = len.a
        return _List_fromArray([_Utils_Tuple2("width", $elm$core$String$fromFloat(x) + "px")])
      case "Percent":
        var x = len.a
        return _List_fromArray([
          _Utils_Tuple2(
            ...
            "calc(" +
              ($elm$core$String$fromFloat(x) +
                ("% - " + ($elm$core$String$fromFloat(adjustment) + "px)")))
          )
        ])
      case "Auto":
        return _List_fromArray([_Utils_Tuple2("width", "auto")])
      case "Fill":
        var i = len.a
        return _List_fromArray([
          _Utils_Tuple2("flex-grow", $elm$core$String$fromFloat(i)),
  ...
  var $mdgriffith$style_elements$Style$Internal$Render$Value$parentAdjustedLength = F2(function (
    len,
    adjustment
  ) {
    switch (len.$) {
  ...
  var $mdgriffith$style_elements$Element$Internal$Render$renderPadding = function (_v0) {
    ...
    return A2(
      ...
      $elm$core$Basics$identity,
      _List_fromArray([
        A2($elm$core$Maybe$map, format("padding-top"), top),
        A2($elm$core$Maybe$map, format("padding-bottom"), bottom),
        A2($elm$core$Maybe$map, format("padding-left"), left),
        A2($elm$core$Maybe$map, format("padding-right"), right)
      ])
    )
  }
  var $mdgriffith$style_elements$Element$Internal$Render$renderAttributes = F6(function (
    elType,
    order,
    maybeElemID,
    parent,
        ...
        if (parent.$ === "Just") {
            ...
            if (_v65.$ === "FlexLayout") {
              switch (_v65.a.$) {
                case "GoRight":
                  ...
                  return _Utils_ap(
                    A2(
                      $mdgriffith$style_elements$Style$Internal$Render$Property$flexWidth,
                      len,
                      paddingAdjustment
                    ),
                    attrs
          ...
          return A2(
            ...
            _Utils_Tuple2(
              "width",
              A2(
                $mdgriffith$style_elements$Style$Internal$Render$Value$parentAdjustedLength,
                len,
                paddingAdjustment
              )
            ),
    ...
    var vertical = function (attrs) {
      ...
      if (_v57.$ === "Nothing") {
        ...
        if (
          elem.inline &&
          _Utils_eq(elType, $mdgriffith$style_elements$Element$Internal$Render$Single)
        ) {
          return attrs
        } else {
          if (elem.inline) {
            ...
            if (!_Utils_eq(elem.frame, $elm$core$Maybe$Nothing)) {
              switch (align.$) {
                case "Top":
                  return A2($elm$core$List$cons, _Utils_Tuple2("top", "0"), attrs)
                case "Bottom":
                  return A2($elm$core$List$cons, _Utils_Tuple2("bottom", "0"), attrs)
                case "VerticalCenter":
                  return attrs
                default:
                  return attrs
              ...
              if (parent.$ === "Nothing") {
                ...
                var parentEl = parent.a
                var _v60 = parentEl.layout
                if (_v60.$ === "FlexLayout") {
                  var dir = _v60.a
                  var _v61 = A2(
                    $mdgriffith$style_elements$Element$Internal$Render$flexboxVerticalIndividualAlignment,
                    dir,
                    align
                  )
                  if (_v61.$ === "Nothing") {
    ...
    var shrink = function (attrs) {
      var _v41 = elem.shrink
      if (_v41.$ === "Just") {
        var i = _v41.a
        return A2(
          $elm$core$List$cons,
          _Utils_Tuple2("flex-shrink", $elm$core$String$fromInt(i)),
          attrs
        )
      } else {
        if (parent.$ === "Nothing") {
          ...
          var _v43 = parentEl.layout
          if (_v43.$ === "FlexLayout") {
            var dir = _v43.a
            if (isHorizontal(dir) && isPx(elem.width)) {
              return A2($elm$core$List$cons, _Utils_Tuple2("flex-shrink", "0"), attrs)
            } else {
              if (isHorizontal(dir) && isPercent(elem.width)) {
                return A2($elm$core$List$cons, _Utils_Tuple2("flex-shrink", "0"), attrs)
              } else {
                if (isHorizontal(dir) && !_Utils_eq(elem.width, $elm$core$Maybe$Nothing)) {
                  return A2($elm$core$List$cons, _Utils_Tuple2("flex-shrink", "1"), attrs)
                } else {
                      ...
                      if (isVertical(dir) && isPercent(elem.height)) {
                        ...
                        if (isVertical(dir) && !_Utils_eq(elem.height, $elm$core$Maybe$Nothing)) {
                          ...
                          if (isVertical(dir) && verticalOverflow) {
                            ...
                            if (
                              isHorizontal(dir) &&
                              _Utils_eq(elem.width, $elm$core$Maybe$Nothing)
                            ) {
                              return A2(
                                $elm$core$List$cons,
                              ...
                              if (
                                isVertical(dir) &&
                                _Utils_eq(elem.height, $elm$core$Maybe$Nothing)
                              ) {
                                if (elType.$ === "Single") {
                                  return A2(
                                    $elm$core$List$cons,
    ...
    var passthrough = function (attrs) {
      var _v40 = elem.pointerevents
      if (_v40.$ === "Nothing") {
        return attrs
      } else {
        if (!_v40.a) {
          return A2($elm$core$List$cons, _Utils_Tuple2("pointer-events", "none"), attrs)
        } else {
          return A2($elm$core$List$cons, _Utils_Tuple2("pointer-events", "auto"), attrs)
        }
      }
    }
    ...
    var overflow = function (attrs) {
      ...
      if (_v38.$ === "Nothing") {
        ...
        switch (o.$) {
          case "XAxis":
            return A2($elm$core$List$cons, _Utils_Tuple2("overflow-x", "auto"), attrs)
          case "YAxis":
            return A2($elm$core$List$cons, _Utils_Tuple2("overflow-y", "auto"), attrs)
          default:
            return A2($elm$core$List$cons, _Utils_Tuple2("overflow", "auto"), attrs)
        }
      }
    }
    var opacity = function (attrs) {
      var _v37 = elem.opacity
      if (_v37.$ === "Nothing") {
        return attrs
      } else {
        var o = _v37.a
        return A2(
          $elm$core$List$cons,
          _Utils_Tuple2("opacity", $elm$core$String$fromFloat(o)),
          attrs
        )
      }
    }
    var layout = function (attrs) {
      if (elType.$ === "Single") {
        return elem.inline
          ? A2($elm$core$List$cons, _Utils_Tuple2("display", "inline"), attrs)
          : A2($elm$core$List$cons, _Utils_Tuple2("display", "block"), attrs)
      } else {
        var lay = elType.a
        return _Utils_ap(
          A2(
            ...
            elem.inline,
            A3(
              $mdgriffith$style_elements$Element$Internal$Render$alignLayout,
              elem.horizontal,
              elem.vertical,
              lay
            )
        ...
        if (
          ...
          switch (align.$) {
            case "Left":
              return A2(
                ...
                A2($elm$core$List$cons, _Utils_Tuple2("float", "left"), attrs)
              )
            case "Right":
              return A2(
                $elm$core$List$cons,
                _Utils_Tuple2("z-index", "1"),
                A2($elm$core$List$cons, _Utils_Tuple2("float", "right"), attrs)
              )
            case "Center":
              return attrs
            default:
          ...
          if (elem.inline) {
            ...
            if (!_Utils_eq(elem.frame, $elm$core$Maybe$Nothing)) {
              switch (align.$) {
                case "Left":
                  return A2($elm$core$List$cons, _Utils_Tuple2("left", "0"), attrs)
                case "Right":
                  return A2($elm$core$List$cons, _Utils_Tuple2("right", "0"), attrs)
                case "Center":
                  return attrs
                default:
                  return attrs
                ...
                if (parent.$ === "Nothing") {
                  ...
                  switch (_v33.$) {
                    ...
                    case "FlexLayout":
                      var dir = _v33.a
                      var _v35 = A2(
                        $mdgriffith$style_elements$Element$Internal$Render$flexboxHorizontalIndividualAlignment,
                        dir,
                        align
                      )
                      if (_v35.$ === "Nothing") {
        ...
        if (parent.$ === "Just") {
          ...
          if (_v22.$ === "FlexLayout") {
            switch (_v22.a.$) {
              ...
              case "GoRight":
                var _v25 = _v22.a
                return hundredPercentOrFill(len)
                  ? A2($elm$core$List$cons, _Utils_Tuple2("height", "auto"), attrs)
                  : A2(
                      $elm$core$List$cons,
                      _Utils_Tuple2(
                        "height",
    ...
    var gridPos = function (attrs) {
      var _v18 = elem.gridPosition
      if (_v18.$ === "Nothing") {
        return attrs
      } else {
        var area = _v18.a
        return A2($elm$core$List$cons, _Utils_Tuple2("grid-area", area), attrs)
      }
    }
    var defaults = _List_fromArray([_Utils_Tuple2("box-sizing", "border-box")])
    var attributes = (function () {
      if (maybeElemID.$ === "Nothing") {
        return elem.attrs
      } else {
        var elemID = maybeElemID.a
        return $elm$core$List$length(elem.variations) > 0
          ? A2(
              $elm$core$List$cons,
          ...
          : A2(
              $elm$core$List$cons,
              $elm$html$Html$Attributes$class(stylesheet.style(elemID)),
              elem.attrs
            )
      }
    })()
    var adjustspacing = function (_v16) {
      ...
      if (onScreen) {
        ...
        if (parent.$ === "Nothing") {
          ...
          var parentEl = parent.a
          var _v11 = parentEl.layout
          if (_v11.$ === "TextLayout") {
            var _v12 = elem.horizontal
            if (_v12.$ === "Nothing") {
              return _Utils_eq(order, $mdgriffith$style_elements$Element$Internal$Render$Last) ||
                _Utils_eq(order, $mdgriffith$style_elements$Element$Internal$Render$FirstAndLast)
                ? A4($mdgriffith$style_elements$Style$Internal$Model$Box, 0, 0, 0, 0)
                : elem.inline
                ? A4($mdgriffith$style_elements$Style$Internal$Model$Box, 0, right, 0, 0)
                : A4($mdgriffith$style_elements$Style$Internal$Model$Box, 0, 0, bottom, 0)
            } else {
              var align = _v12.a
                ...
                switch (align.$) {
                  case "Left":
                    return _Utils_eq(
                      ...
                      ? A4($mdgriffith$style_elements$Style$Internal$Model$Box, 0, right, bottom, 0)
                      : _Utils_eq(
                          order,
                          $mdgriffith$style_elements$Element$Internal$Render$FirstAndLast
                        )
                      ? A4($mdgriffith$style_elements$Style$Internal$Model$Box, 0, right, 0, 0)
                      : _Utils_eq(order, $mdgriffith$style_elements$Element$Internal$Render$Last)
                      ? A4($mdgriffith$style_elements$Style$Internal$Model$Box, 0, right, 0, 0)
                      : A4($mdgriffith$style_elements$Style$Internal$Model$Box, 0, right, bottom, 0)
                  case "Right":
                    return _Utils_eq(
                      ...
                      ? A4($mdgriffith$style_elements$Style$Internal$Model$Box, 0, 0, bottom, left)
                      : _Utils_eq(
                          order,
                          $mdgriffith$style_elements$Element$Internal$Render$FirstAndLast
                        )
                      ? A4($mdgriffith$style_elements$Style$Internal$Model$Box, 0, 0, 0, left)
                      : _Utils_eq(order, $mdgriffith$style_elements$Element$Internal$Render$Last)
                      ? A4($mdgriffith$style_elements$Style$Internal$Model$Box, 0, 0, 0, left)
                      : A4($mdgriffith$style_elements$Style$Internal$Model$Box, 0, 0, bottom, left)
                  default:
    ...
    var spacing = function (attrs) {
      ...
      if (_v9.$ === "Nothing") {
        ...
        return A2(
          ...
          _Utils_Tuple2(
            "margin",
            $mdgriffith$style_elements$Style$Internal$Render$Value$box(adjustspacing(space))
          ),
          attrs
        )
      }
          ...
          if (parent.$ === "Nothing") {
            ...
            switch (_v2.$) {
              case "TextLayout":
                var borders = $elm$core$List$concat(
                  _List_fromArray([
                    _Utils_eq(order, $mdgriffith$style_elements$Element$Internal$Render$Last)
                      ...
                      : _Utils_eq(order, $mdgriffith$style_elements$Element$Internal$Render$First)
                      ? _List_fromArray([
                ...
                var _v3 = parentEl.parentPadding
                var top = _v3.a
                var right = _v3.b
                var bottom = _v3.c
                var left = _v3.d
                return _Utils_ap(
                  _List_fromArray([
                    ...
                    _Utils_eq(
                      ...
                      ? _Utils_Tuple2("margin-top", $elm$core$String$fromFloat(-1 * top) + "px")
                      : _Utils_Tuple2("margin-top", "0"),
                    _Utils_eq(order, $mdgriffith$style_elements$Element$Internal$Render$Last) ||
                    _Utils_eq(
                      order,
                      $mdgriffith$style_elements$Element$Internal$Render$FirstAndLast
                      ...
                      ? _Utils_Tuple2(
                          "margin-bottom",
                          $elm$core$String$fromFloat(-1 * bottom) + "px"
                        )
              ...
              case "FlexLayout":
                ...
                var flex = _v2.b
                var _v4 = (function () {
                  var _v5 = parentEl.parentSpecifiedSpacing
                  if (_v5.$ === "Nothing") {
                    return A4($mdgriffith$style_elements$Style$Internal$Model$Box, 0, 0, 0, 0)
                  } else {
                    var p = _v5.a
                ...
                var _v6 = parentEl.parentPadding
                var top = _v6.a
                var right = _v6.b
                var bottom = _v6.c
                var left = _v6.d
                    ...
                    return width(
                      _List_fromArray([
                        _Utils_Tuple2(
                          ...
                          "calc(100% + " +
                            ($elm$core$String$fromFloat(
                              top + bottom - (parentSpaceTop + parentSpaceBottom) / 2
                            ) +
                              "px")
                        ),
                        _Utils_Tuple2("margin", "0"),
                        ...
                        _Utils_eq(
                          ...
                          ? _Utils_Tuple2(
                              "margin-right",
                              $elm$core$String$fromFloat(-1 * right) + "px"
                            )
                          : _Utils_Tuple2(
                              "margin-right",
                    ...
                    return height(
                      _List_fromArray([
                        _Utils_Tuple2(
                          ...
                          "calc(100% + " +
                            ($elm$core$String$fromFloat(
                              left + right - (parentSpaceLeft + parentSpaceRight) / 2
                            ) +
                              "px")
                        ),
                        _Utils_Tuple2("margin", "0"),
                        ...
                        _Utils_eq(
                          ...
                          ? _Utils_Tuple2(
                              "margin-bottom",
                              $elm$core$String$fromFloat(-1 * top) + "px"
                            )
                          : _Utils_Tuple2(
                              "margin-bottom",
  ...
  var $mdgriffith$style_elements$Element$Internal$Render$renderElement = F4(function (
    parent,
    stylesheet,
    order,
    elm
      ...
      case "Text":
        ...
        var attrs = inline
          ? $mdgriffith$style_elements$Element$Internal$Render$renderSyleAttributes(
              _List_fromArray([_Utils_Tuple2("display", "inline")])
            )
          : $mdgriffith$style_elements$Element$Internal$Render$renderSyleAttributes(
              _List_fromArray([
        ...
        switch (decoration.$) {
          case "NoDecoration":
            return A2(
              $elm$html$Html$span,
              A2($elm$core$List$cons, $elm$html$Html$Attributes$class("el"), attrs),
      ...
      case "Element":
        ...
        var attributes = (function () {
          if (parent.$ === "Nothing") {
            ...
            var ctxt = parent.a
            var _v6 = ctxt.parentSpecifiedSpacing
            if (_v6.$ === "Nothing") {
              return parentTextLayout(ctxt.layout) ||
                A2(
                  $elm$core$List$any,
                  $elm$core$Basics$eq($mdgriffith$style_elements$Element$Internal$Model$Inline),
                  attrs
                )
                ? $mdgriffith$style_elements$Element$Internal$Render$spacingToMargin(attrs)
                : attrs
            } else {
              var _v7 = _v6.a
              var top = _v7.a
        ...
        return A3(
          $elm$html$Html$node,
          node,
          A2($elm$core$List$cons, $elm$html$Html$Attributes$class("el"), htmlAttrs),
          childHtml
        )
      default:
        var node = elm.a.node
        ...
        var clearfix = function (allAttrs) {
          if (layout.$ === "TextLayout") {
            var fix = layout.a
            return fix
              ? A2($elm$core$List$cons, $elm$html$Html$Attributes$class("clearfix"), allAttrs)
              : allAttrs
          } else {
            return allAttrs
          }
        ...
        var attributes = (function () {
          if (parent.$ === "Nothing") {
            ...
            var ctxt = parent.a
            var _v18 = ctxt.parentSpecifiedSpacing
            if (_v18.$ === "Nothing") {
              return attrs
            } else {
              var _v19 = _v18.a
        ...
        var padding = (function () {
          var _v16 = $elm$core$List$head(A2($elm$core$List$filterMap, forPadding, attributes))
          if (_v16.$ === "Nothing") {
            return A4($mdgriffith$style_elements$Style$Internal$Model$Box, 0, 0, 0, 0)
          } else {
            var pad = _v16.a
        ...
        var _v10 = A2($elm$core$List$partition, forSpacing, attrs)
  ...
  var $mdgriffith$style_elements$Element$Internal$Render$render = F2(function (stylesheet, elm) {
  ...
  var $mdgriffith$style_elements$Element$Internal$Render$viewport = F2(function (stylesheet, elm) {
    return A2(
      $elm$html$Html$div,
      _List_fromArray([
  ...
  var $mdgriffith$style_elements$Element$viewport =
    $mdgriffith$style_elements$Element$Internal$Render$viewport
  ...
  _Platform_export({
    Main: { init: $author$project$Main$main($elm$json$Json$Decode$succeed(_Utils_Tuple0))(0) }
  })
})(this)
