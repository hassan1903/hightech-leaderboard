...
var $author$project$Main$HttpPlayerData = F4(
	function (playerId, hasBeenForgotten, playerInvocations, playerProgress) {
		return {hasBeenForgotten: hasBeenForgotten, playerId: playerId, playerInvocations: playerInvocations, playerProgress: playerProgress};
	});
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $author$project$Main$PlayerInvocations = F2(
	function (http, gRPC) {
...
var $author$project$Main$SignalRPlayerData = F8(
	function (playerId, name, eEgg, score, scoreInHand, scoreInBag, currentMaze, mazePlayInfos) {
		return {currentMaze: currentMaze, eEgg: eEgg, mazePlayInfos: mazePlayInfos, name: name, playerId: playerId, score: score, scoreInBag: scoreInBag, scoreInHand: scoreInHand};
	});
var $author$project$Main$SignalRMazePlayInfo = F4(
	function (hasBeenPlayed, name, obtainedReward, potentialReward) {
		return {hasBeenPlayed: hasBeenPlayed, name: name, obtainedReward: obtainedReward, potentialReward: potentialReward};
	});
...
var $author$project$Main$decodeLeaderboardAllData = $elm$json$Json$Decode$list($author$project$Main$decodeHttpPlayerData);
...
var $author$project$Main$getLeaderboardAllData = $elm$http$Http$get(
	{
		expect: A2(
			...
			A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Main$LeaderboardDataResponse),
...
var $author$project$Main$onSignalRConnection = _Platform_incomingPort('onSignalRConnection', $elm$json$Json$Decode$bool);
var $author$project$Main$playerForgotten = _Platform_incomingPort('playerForgotten', $elm$json$Json$Decode$string);
														...
														function (eEgg) {
															return A2(
																...
																function (currentMaze) {
																	return $elm$json$Json$Decode$succeed(
																		{currentMaze: currentMaze, eEgg: eEgg, mazePlayInfos: mazePlayInfos, name: name, playerId: playerId, score: score, scoreInBag: scoreInBag, scoreInHand: scoreInHand});
																},
																A2($elm$json$Json$Decode$field, 'currentMaze', $elm$json$Json$Decode$string));
														},
																			...
																			function (name) {
																				return A2(
																					...
																					function (hasBeenPlayed) {
																						return $elm$json$Json$Decode$succeed(
																							{hasBeenPlayed: hasBeenPlayed, name: name, obtainedReward: obtainedReward, potentialReward: potentialReward});
																					},
																					A2($elm$json$Json$Decode$field, 'hasBeenPlayed', $elm$json$Json$Decode$bool));
																			},
																			A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string));
																	},
																	A2($elm$json$Json$Decode$field, 'obtainedReward', $elm$json$Json$Decode$int));
															},
															A2($elm$json$Json$Decode$field, 'potentialReward', $elm$json$Json$Decode$int)))));
										},
										A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string));
								},
...
var $author$project$Main$ghostPlayer = F2(
	function (playerId, invocations) {
		return {hasFoundEasterEgg: $elm$core$Maybe$Nothing, invocations: invocations, mazeResults: $elm$core$Dict$empty, name: '👻', playerId: playerId, score: 0, scoreInBag: 0, scoreInHand: 0};
	});
var $author$project$Main$initInvocations = {gRPC: 0, http: 0};
var $author$project$Main$forgetPlayer = F2(
	function (playerId, model) {
		var updatePlayer = function (maybePlayer) {
			if (maybePlayer.$ === 'Just') {
				var p = maybePlayer.a;
				return $elm$core$Maybe$Just(
					A2($author$project$Main$ghostPlayer, playerId, p.invocations));
			} else {
				return $elm$core$Maybe$Just(
...
var $author$project$Main$activePlayer = F2(
	function (playerData, invocations) {
		var toMazeResult = function (signalRMazePlayInfo) {
			var progress = ((playerData.scoreInHand + playerData.scoreInBag) / signalRMazePlayInfo.potentialReward) * 100;
			var mazeStatus = _Utils_eq(playerData.currentMaze, signalRMazePlayInfo.name) ? $author$project$Main$InProgress(
				$elm$core$Basics$round(progress)) : (signalRMazePlayInfo.hasBeenPlayed ? (_Utils_eq(signalRMazePlayInfo.potentialReward, signalRMazePlayInfo.obtainedReward) ? $author$project$Main$Played($author$project$Main$Perfect) : $author$project$Main$Played(
				$author$project$Main$Imperfect(
					$elm$core$Basics$round((signalRMazePlayInfo.obtainedReward / signalRMazePlayInfo.potentialReward) * 100)))) : $author$project$Main$NotPlayed);
...
var $author$project$Main$setPlayerDataFromHttpResponse = F2(
...
var $author$project$Main$setPlayerInvocations = F3(
	function (playerId, invocations, model) {
		var updatePlayer = function (maybePlayer) {
			if (maybePlayer.$ === 'Just') {
				var p = maybePlayer.a;
				return $elm$core$Maybe$Just(
				...
				return $elm$core$Maybe$Just(
					A2($author$project$Main$ghostPlayer, playerId, invocations));
			}
		};
		var updatedPlayers = A3($elm$core$Dict$update, playerId, updatePlayer, model.players);
		return _Utils_update(
...
var $author$project$Main$updatePlayerData = F2(
	function (newPlayerData, model) {
		var player = function (invocations) {
			return $elm$core$Maybe$Just(
				A2($author$project$Main$activePlayer, newPlayerData, invocations));
		};
		var updatePlayer = function (maybePlayer) {
			if (maybePlayer.$ === 'Just') {
				var p = maybePlayer.a;
		...
		var updatedPlayers = A3($elm$core$Dict$update, newPlayerData.playerId, updatePlayer, model.players);
		return _Utils_update(
			model,
			{players: updatedPlayers});
	});
		...
		switch (msg.$) {
			...
			case 'OnSignalRConnectionChanged':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{isSignalRConnected: newSignalRStatus}),
					$elm$core$Platform$Cmd$none);
			...
			default:
				...
				return _Utils_Tuple2(
					...
					A3($andrewMacmurray$elm_delay$Delay$after, 1, $andrewMacmurray$elm_delay$Delay$Second, $author$project$Main$RefreshLeaderboardData));
		}
	});
...
var $author$project$Main$mazeStatusCellHeight = $mdgriffith$style_elements$Element$Attributes$px(40);
var $author$project$Main$mazeStatusCellWidth = $mdgriffith$style_elements$Element$Attributes$px(20);
...
var $author$project$Main$mazeStatusView = function (status) {
	return A3(
		...
		_List_fromArray(
			[
				$mdgriffith$style_elements$Element$Attributes$width($author$project$Main$mazeStatusCellWidth),
				$mdgriffith$style_elements$Element$Attributes$height($author$project$Main$mazeStatusCellHeight),
				$mdgriffith$style_elements$Element$Attributes$alignBottom
			]),
		_List_fromArray(
			[
				$author$project$Main$renderMazeStatus(status)
			]));
};
...
var $author$project$Main$playerRow = F2(
	function (position, playerData) {
		...
		return A3(
			...
			$author$project$Main$RowStyle(
				$author$project$Main$toStyle(position)),
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					$mdgriffith$style_elements$Element$text(
						$author$project$Main$toOrdinal(newPosition))),
					A3(
					$mdgriffith$style_elements$Element$el,
					...
					_List_fromArray(
						[
							$mdgriffith$style_elements$Element$text(playerData.name),
							easterEgg
						])),
					A3(
					$mdgriffith$style_elements$Element$el,
					...
					_List_fromArray(
						[
							$mdgriffith$style_elements$Element$Attributes$spacing(10)
						]),
					A2(
						$elm$core$List$map,
...
var $author$project$Main$mazeNameCell = function (mazeName) {
	return A3(
		...
		$mdgriffith$style_elements$Element$text(
			$elm$core$String$fromInt(mazeName)));
};
			...
			[
				...
				A2(
					...
					A2(
						$elm$core$List$range,
						1,
						$elm$core$List$length(mazeNames))))
			]));
};
var $author$project$Main$sortByScoreAndInvocations = F2(
	function (p1, p2) {
	...
	return A3(
		...
		A2(
			...
			_Utils_ap(
				...
				_List_fromArray(
					[
						$author$project$Main$mazeLegendRow(model)
					]))));
};
...
var $author$project$Main$signalRConnectivity = function (isSignalRConnected) {
	var statusSymbol = isSignalRConnected ? $mdgriffith$style_elements$Element$text('✅') : $mdgriffith$style_elements$Element$text('❌');
	return A3(
		$mdgriffith$style_elements$Element$el,
		$author$project$Main$NoStyle,
		_List_fromArray(
...
var $author$project$Main$layout = function (model) {
	return A3(
		...
		_List_fromArray(
			[
				$author$project$Main$head(model),
...
var $mdgriffith$style_elements$Style$Internal$Intermediate$hash = function (value) {
	return $elm$core$String$fromInt(
		A2($robinheghan$murmur3$Murmur3$hashString, 8675309, value));
};
...
var $author$project$Main$stylesheet = $mdgriffith$style_elements$Style$styleSheet(
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$mdgriffith$style_elements$Style$Font$size(30)
				])),
			A2(
			$mdgriffith$style_elements$Style$style,
			...
			_List_fromArray(
				[
					$mdgriffith$style_elements$Style$Font$size(10)
				])),
			A2(
			$mdgriffith$style_elements$Style$style,
			$author$project$Main$PlayerIdText,
		...
		switch (elemen.$) {
			case 'Element':
				...
				var adjustAndMerge = F2(
					function (el, _v8) {
						...
						var _v6 = A3($mdgriffith$style_elements$Element$Internal$Model$adjust, fn, $elm$core$Maybe$Nothing, el);
						var adjusted = _v6.a;
						var data = _v6.b;
						if (data.$ === 'Nothing') {
							return _Utils_Tuple2(
				...
				var _v4 = A3($mdgriffith$style_elements$Element$Internal$Model$adjust, fn, $elm$core$Maybe$Nothing, child);
			...
			case 'Layout':
				...
				var adjustAndMergeKeyed = F3(
					function (usingParent, _v22, _v23) {
						var key = _v22.a;
						var el = _v22.b;
						var adjustedAggregate = _v23.a;
						var dataAggregate = _v23.b;
						var _v20 = A3($mdgriffith$style_elements$Element$Internal$Model$adjust, fn, usingParent, el);
						var adjusted = _v20.a;
						var data = _v20.b;
						if (data.$ === 'Nothing') {
							return _Utils_Tuple2(
				...
				var adjustAndMerge = F3(
					function (usingParent, el, _v19) {
						var adjustedAggregate = _v19.a;
						var dataAggregate = _v19.b;
						var _v17 = A3($mdgriffith$style_elements$Element$Internal$Model$adjust, fn, usingParent, el);
						var adjusted = _v17.a;
						var data = _v17.b;
						if (data.$ === 'Nothing') {
							return _Utils_Tuple2(
...
var $mdgriffith$style_elements$Element$Internal$Adjustments$positionNearby = F2(
	function (parent, elm) {
		var setPosition = F3(
			function (nearbyPosition, _v24, el) {
				var aligned = _v24.a;
					...
					if (elem.inline) {
						...
						if (!_Utils_eq(elem.frame, $elm$core$Maybe$Nothing)) {
							...
							if (parent.$ === 'Nothing') {
								...
								if (_v60.$ === 'FlexLayout') {
									var dir = _v60.a;
									var _v61 = A2($mdgriffith$style_elements$Element$Internal$Render$flexboxVerticalIndividualAlignment, dir, align);
									if (_v61.$ === 'Nothing') {
										return attrs;
									} else {
										var a = _v61.a;
							...
							if (elType.$ === 'LayoutElement') {
								...
								if (parent.$ === 'Nothing') {
									...
									switch (_v33.$) {
										...
										case 'FlexLayout':
											var dir = _v33.a;
											var _v35 = A2($mdgriffith$style_elements$Element$Internal$Render$flexboxHorizontalIndividualAlignment, dir, align);
											if (_v35.$ === 'Nothing') {
												return attrs;
											} else {
												var a = _v35.a;
